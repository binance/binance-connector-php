...
class FlexibleRateApi
{
    ...
    public function checkCollateralRepayRateRequest($loanCoin, $collateralCoin, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling FlexibleRateApi.checkCollateralRepayRate, must be smaller than or equal to 60000.');
        }
    ...
    public function getFlexibleLoanAssetsDataRequest($loanCoin = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling FlexibleRateApi.getFlexibleLoanAssetsData, must be smaller than or equal to 60000.');
        }
    ...
    public function getFlexibleLoanBorrowHistoryRequest($loanCoin = null, $collateralCoin = null, $startTime = null, $endTime = null, $current = null, $limit = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current > 1000) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling FlexibleRateApi.getFlexibleLoanBorrowHistory, must be smaller than or equal to 1000.');
        }
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling FlexibleRateApi.getFlexibleLoanBorrowHistory, must be bigger than or equal to 1.');
        }

        if (null !== $limit && $limit > 100) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling FlexibleRateApi.getFlexibleLoanBorrowHistory, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling FlexibleRateApi.getFlexibleLoanBorrowHistory, must be smaller than or equal to 60000.');
        }
    ...
    public function getFlexibleLoanCollateralAssetsDataRequest($collateralCoin = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling FlexibleRateApi.getFlexibleLoanCollateralAssetsData, must be smaller than or equal to 60000.');
        }
    ...
    public function getFlexibleLoanInterestRateHistoryRequest($coin, $recvWindow, $startTime = null, $endTime = null, $current = null, $limit = null)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling FlexibleRateApi.getFlexibleLoanInterestRateHistory, must be smaller than or equal to 60000.');
        }

        if (null !== $current && $current > 1000) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling FlexibleRateApi.getFlexibleLoanInterestRateHistory, must be smaller than or equal to 1000.');
        }
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling FlexibleRateApi.getFlexibleLoanInterestRateHistory, must be bigger than or equal to 1.');
        }

        if (null !== $limit && $limit > 100) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling FlexibleRateApi.getFlexibleLoanInterestRateHistory, must be smaller than or equal to 100.');
        }
    ...
    public function getFlexibleLoanLiquidationHistoryRequest($loanCoin = null, $collateralCoin = null, $startTime = null, $endTime = null, $current = null, $limit = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current > 1000) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling FlexibleRateApi.getFlexibleLoanLiquidationHistory, must be smaller than or equal to 1000.');
        }
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling FlexibleRateApi.getFlexibleLoanLiquidationHistory, must be bigger than or equal to 1.');
        }

        if (null !== $limit && $limit > 100) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling FlexibleRateApi.getFlexibleLoanLiquidationHistory, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling FlexibleRateApi.getFlexibleLoanLiquidationHistory, must be smaller than or equal to 60000.');
        }
    ...
    public function getFlexibleLoanLtvAdjustmentHistoryRequest($loanCoin = null, $collateralCoin = null, $startTime = null, $endTime = null, $current = null, $limit = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current > 1000) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling FlexibleRateApi.getFlexibleLoanLtvAdjustmentHistory, must be smaller than or equal to 1000.');
        }
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling FlexibleRateApi.getFlexibleLoanLtvAdjustmentHistory, must be bigger than or equal to 1.');
        }

        if (null !== $limit && $limit > 100) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling FlexibleRateApi.getFlexibleLoanLtvAdjustmentHistory, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling FlexibleRateApi.getFlexibleLoanLtvAdjustmentHistory, must be smaller than or equal to 60000.');
        }
    ...
    public function getFlexibleLoanOngoingOrdersRequest($loanCoin = null, $collateralCoin = null, $current = null, $limit = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current > 1000) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling FlexibleRateApi.getFlexibleLoanOngoingOrders, must be smaller than or equal to 1000.');
        }
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling FlexibleRateApi.getFlexibleLoanOngoingOrders, must be bigger than or equal to 1.');
        }

        if (null !== $limit && $limit > 100) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling FlexibleRateApi.getFlexibleLoanOngoingOrders, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling FlexibleRateApi.getFlexibleLoanOngoingOrders, must be smaller than or equal to 60000.');
        }
    ...
    public function getFlexibleLoanRepaymentHistoryRequest($loanCoin = null, $collateralCoin = null, $startTime = null, $endTime = null, $current = null, $limit = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current > 1000) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling FlexibleRateApi.getFlexibleLoanRepaymentHistory, must be smaller than or equal to 1000.');
        }
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling FlexibleRateApi.getFlexibleLoanRepaymentHistory, must be bigger than or equal to 1.');
        }

        if (null !== $limit && $limit > 100) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling FlexibleRateApi.getFlexibleLoanRepaymentHistory, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling FlexibleRateApi.getFlexibleLoanRepaymentHistory, must be smaller than or equal to 60000.');
        }
