...
class FlexibleLoanBorrowRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets loanAmount.
     *
     * @param null|float $loanAmount Mandatory when collateralAmount is empty
     *
     * @return self
     */
     ...
     *
     * @param null|float $collateralAmount Mandatory when loanAmount is empty
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling FlexibleLoanBorrowRequest., must be smaller than or equal to 60000.');
        }
