...
/**
 * FlexibleLoanAdjustLtvRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class FlexibleLoanAdjustLtvRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'flexibleLoanAdjustLtvRequest';
    ...
    protected static $openAPITypes = [
        ...
        'direction' => '\Binance\Client\CryptoLoan\Model\Direction',
        'recvWindow' => 'int',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('adjustmentAmount', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['adjustmentAmount']) {
            $invalidProperties[] = "'adjustmentAmount' can't be null";
        }
        if (null === $this->container['direction']) {
     ...
     *
     * @param float $adjustmentAmount adjustmentAmount
     *
     * @return self
     */
    public function setAdjustmentAmount($adjustmentAmount)
    {
        if (is_null($adjustmentAmount)) {
            throw new \InvalidArgumentException('non-nullable adjustmentAmount cannot be null');
        }
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling FlexibleLoanAdjustLtvRequest., must be smaller than or equal to 60000.');
        }
