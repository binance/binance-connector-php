...
/**
 * GetFlexibleLoanLtvAdjustmentHistoryResponseRowsInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class GetFlexibleLoanLtvAdjustmentHistoryResponseRowsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getFlexibleLoanLtvAdjustmentHistoryResponse_rows_inner';
    ...
    protected static $setters = [
        ...
        'preLTV' => 'setPreLTV',
        'afterLTV' => 'setAfterLTV',
        'adjustTime' => 'setAdjustTime',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('preLTV', $data ?? [], null);
        $this->setIfExists('afterLTV', $data ?? [], null);
        $this->setIfExists('adjustTime', $data ?? [], null);
    }
    ...
    {
        return $this->container['preLTV'];
    }

    /**
     * Sets preLTV.
     *
     * @param null|string $preLTV preLTV
     *
     * @return self
     */
    public function setPreLTV($preLTV)
    {
        if (is_null($preLTV)) {
            throw new \InvalidArgumentException('non-nullable preLTV cannot be null');
        }
        $this->container['preLTV'] = $preLTV;
    ...
    {
        return $this->container['afterLTV'];
    }

    /**
     * Sets afterLTV.
     *
     * @param null|string $afterLTV afterLTV
     *
     * @return self
     */
    public function setAfterLTV($afterLTV)
    {
        if (is_null($afterLTV)) {
            throw new \InvalidArgumentException('non-nullable afterLTV cannot be null');
        }
        $this->container['afterLTV'] = $afterLTV;
    ...
    {
        return $this->container['adjustTime'];
    }

    /**
     * Sets adjustTime.
     *
     * @param null|int $adjustTime adjustTime
     *
     * @return self
     */
    public function setAdjustTime($adjustTime)
    {
        if (is_null($adjustTime)) {
            throw new \InvalidArgumentException('non-nullable adjustTime cannot be null');
        }
        $this->container['adjustTime'] = $adjustTime;
