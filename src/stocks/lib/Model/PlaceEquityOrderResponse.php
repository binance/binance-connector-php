...
/**
 * PlaceEquityOrderResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class PlaceEquityOrderResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'placeEquityOrderResponse';
     ...
     * Sets status.
     *
     * @param null|string $status Acknowledgement code: `S` = accepted, `F` = failed. Not an order lifecycle status — to poll lifecycle, call `/order/detail` or `/order/history`.
     *
     * @return self
     */
     ...
     * Sets orderId.
     *
     * @param null|string $orderId order id (UUID)
     *
     * @return self
     */
     ...
     * Sets clientOrderId.
     *
     * @param null|string $clientOrderId echoes the supplied or server-generated client order id
     *
     * @return self
     */
