...
/**
 * CreateRenewListenKeyResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class CreateRenewListenKeyResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createRenewListenKeyResponse';
     ...
     * Sets listenKey.
     *
     * @param null|string $listenKey session identifier for the stock user data stream
     *
     * @return self
     */
