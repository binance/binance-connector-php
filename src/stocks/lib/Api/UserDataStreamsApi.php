...
class UserDataStreamsApi
{
    ...
    public const contentTypes = [
        'createRenewListenKey' => ['application/x-www-form-urlencoded'],
    ];
    ...
    {
        return $this->createRenewListenKeyWithHttpInfo($recvWindow);
    }

    /**
     * Operation createRenewListenKeyWithHttpInfo.
     *
     * Create / Renew Listen Key (USER_STREAM)
     *
     * @param null|int $recvWindow The value cannot be greater than &#x60;60000&#x60;. (optional)
     ...
     * @throws \InvalidArgumentException
     */
    public function createRenewListenKeyWithHttpInfo($recvWindow = null): ApiResponse
    {
        $request = $this->createRenewListenKeyRequest($recvWindow);
            ...
            switch ($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Binance\Client\Stocks\Model\CreateRenewListenKeyResponse',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Create request for operation 'createRenewListenKey'.
     *
     * @param null|int $recvWindow The value cannot be greater than &#x60;60000&#x60;. (optional)
     *
     * @return Request
     ...
     * @throws \InvalidArgumentException
     */
    public function createRenewListenKeyRequest($recvWindow = null)
    {
        $contentType = self::contentTypes['createRenewListenKey'][0];

        $resourcePath = '/sapi/v1/equity/listenKey';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
