...
class AccountApi
{
    ...
    public const contentTypes = [
        'signUsEquityDisclaimer' => ['application/x-www-form-urlencoded'],
    ];
    ...
    {
        return $this->signUsEquityDisclaimerWithHttpInfo($recvWindow);
    }

    /**
     * Operation signUsEquityDisclaimerWithHttpInfo.
     *
     * Sign US Equity Disclaimer (TRADE)
     *
     * @param null|int $recvWindow The value cannot be greater than &#x60;60000&#x60;. (optional)
     ...
     * @throws \InvalidArgumentException
     */
    public function signUsEquityDisclaimerWithHttpInfo($recvWindow = null): ApiResponse
    {
        $request = $this->signUsEquityDisclaimerRequest($recvWindow);
            ...
            switch ($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Binance\Client\Stocks\Model\SignUsEquityDisclaimerResponse',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Create request for operation 'signUsEquityDisclaimer'.
     *
     * @param null|int $recvWindow The value cannot be greater than &#x60;60000&#x60;. (optional)
     *
     * @return Request
     ...
     * @throws \InvalidArgumentException
     */
    public function signUsEquityDisclaimerRequest($recvWindow = null)
    {
        $contentType = self::contentTypes['signUsEquityDisclaimer'][0];

        $resourcePath = '/sapi/v1/equity/account/disclaimer';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
