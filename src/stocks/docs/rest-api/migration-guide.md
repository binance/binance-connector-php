# Migration Guide: Binance Stocks Connector Modularization
...
1. **Package Name**:  
   The modularised Stocks Connector has been moved to a new package:
...
4. **Configuration and Client Initialization**:  
   The new structure keeps the existing configuration options but modularized clients into `StocksRestApi`.
