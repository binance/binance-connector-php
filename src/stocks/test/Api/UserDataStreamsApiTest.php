...
use Binance\Client\Stocks\Api\UserDataStreamsApi;
...
class UserDataStreamsApiTest extends TestCase
{
    ...
    /**
     * Test case for createRenewListenKey.
     *
     * Create / Renew Listen Key (USER_STREAM).
     */
    public function testCreateRenewListenKey()
    {
        $recvWindow = 5000;
        $response = $this->getApiMock($request)->createRenewListenKey($recvWindow);

        parse_str($request->getUri(), $queryMap);

        self::assertEquals(200, $response->getStatusCode());
        self::assertEquals('/sapi/v1/equity/listenKey', $request->getUri()->getPath());
