...
class DefaultApi
{
    ...
    public function getSpotRebateHistoryRecordsRequest($startTime = null, $endTime = null, $page = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling DefaultApi.getSpotRebateHistoryRecords, must be smaller than or equal to 60000.');
        }
