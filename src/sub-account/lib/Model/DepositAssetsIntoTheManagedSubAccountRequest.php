...
/**
 * DepositAssetsIntoTheManagedSubAccountRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class DepositAssetsIntoTheManagedSubAccountRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'depositAssetsIntoTheManagedSubAccountRequest';
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling DepositAssetsIntoTheManagedSubAccountRequest., must be smaller than or equal to 60000.');
        }
