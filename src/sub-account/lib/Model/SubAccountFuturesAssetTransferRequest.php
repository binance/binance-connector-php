...
class SubAccountFuturesAssetTransferRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling SubAccountFuturesAssetTransferRequest., must be smaller than or equal to 60000.');
        }
