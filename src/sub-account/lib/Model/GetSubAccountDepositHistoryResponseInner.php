...
/**
 * GetSubAccountDepositHistoryResponseInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class GetSubAccountDepositHistoryResponseInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getSubAccountDepositHistoryResponse_inner';
     ...
     * Sets status.
     *
     * @param null|int $status deposit status: 0=pending, 6=credited but cannot withdraw, 7=wrong deposit, 8=waiting user confirmation, 1=success
     *
     * @return self
     */
