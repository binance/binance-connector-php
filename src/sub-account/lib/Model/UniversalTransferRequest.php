...
class UniversalTransferRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'fromEmail' => 'string',
        'toEmail' => 'string',
        'fromAccountType' => '\Binance\Client\SubAccount\Model\FromAccountType',
        'toAccountType' => '\Binance\Client\SubAccount\Model\ToAccountType',
        'clientTranId' => 'string',
        'symbol' => 'string',
        'asset' => 'string',
        'amount' => 'float',
     ...
     *
     * @param FromAccountType $fromAccountType fromAccountType
     *
     * @return self
     */
     ...
     * Sets toAccountType.
     *
     * @param ToAccountType $toAccountType toAccountType
     *
     * @return self
     */
     ...
     * Sets clientTranId.
     *
     * @param null|string $clientTranId Must be unique
     *
     * @return self
     */
     ...
     * Sets symbol.
     *
     * @param null|string $symbol Only supported under ISOLATED_MARGIN type
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling UniversalTransferRequest., must be smaller than or equal to 60000.');
        }
