...
/**
 * EnableOptionsForSubAccountRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class EnableOptionsForSubAccountRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'enableOptionsForSubAccountRequest';
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling EnableOptionsForSubAccountRequest., must be smaller than or equal to 60000.');
        }
