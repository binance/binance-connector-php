...
/**
 * QueryManagedSubAccountTransferLogMasterAccountInvestorResponseManagerSubTransferHistoryVosInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class QueryManagedSubAccountTransferLogMasterAccountInvestorResponseManagerSubTransferHistoryVosInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'queryManagedSubAccountTransferLogMasterAccountInvestorResponse_managerSubTransferHistoryVos_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('scheduledData', $data ?? [], null);
    ...
    {
        return $this->container['scheduledData'];
    }

    /**
     * Sets scheduledData.
     *
     * @param null|int $scheduledData scheduledData
     *
     * @return self
     */
    public function setScheduledData($scheduledData)
    {
        if (is_null($scheduledData)) {
            throw new \InvalidArgumentException('non-nullable scheduledData cannot be null');
        }
        $this->container['scheduledData'] = $scheduledData;
