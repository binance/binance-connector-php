...
/**
 * WithdrawlAssetsFromTheManagedSubAccountRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class WithdrawlAssetsFromTheManagedSubAccountRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'withdrawlAssetsFromTheManagedSubAccountRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('transferDate', $data ?? [], null);
     ...
     * Sets transferDate.
     *
     * @param null|int $transferDate Withdrawal will happen automatically on the selected date (UTC 0). If no date is selected, withdrawal takes effect immediately.
     *
     * @return self
     */
    public function setTransferDate($transferDate)
    {
        if (is_null($transferDate)) {
            throw new \InvalidArgumentException('non-nullable transferDate cannot be null');
        }
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling WithdrawlAssetsFromTheManagedSubAccountRequest., must be smaller than or equal to 60000.');
        }
