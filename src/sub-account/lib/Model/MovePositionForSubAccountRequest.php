...
/**
 * MovePositionForSubAccountRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class MovePositionForSubAccountRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'movePositionForSubAccountRequest';
    ...
    protected static $openAPITypes = [
        ...
        'toUserEmail' => 'string',
        'productType' => '\Binance\Client\SubAccount\Model\ProductType',
        'orderArgs' => '\Binance\Client\SubAccount\Model\OrderArgs',
        'recvWindow' => 'int',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('orderArgs', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['fromUserEmail']) {
            $invalidProperties[] = "'fromUserEmail' can't be null";
        }
        if (null === $this->container['toUserEmail']) {
            $invalidProperties[] = "'toUserEmail' can't be null";
        }
        if (null === $this->container['productType']) {
            $invalidProperties[] = "'productType' can't be null";
        }
        if (null === $this->container['orderArgs']) {
            $invalidProperties[] = "'orderArgs' can't be null";
        }
     ...
     * Sets fromUserEmail.
     *
     * @param string $fromUserEmail fromUserEmail
     *
     * @return self
     */
     ...
     * Sets toUserEmail.
     *
     * @param string $toUserEmail toUserEmail
     *
     * @return self
     */
     ...
     * @return OrderArgs
     */
    public function getOrderArgs()
    {
        return $this->container['orderArgs'];
    }

    /**
     * Sets orderArgs.
     *
     * @param OrderArgs $orderArgs orderArgs
     *
     * @return self
     */
    public function setOrderArgs($orderArgs)
    {
        if (is_null($orderArgs)) {
            throw new \InvalidArgumentException('non-nullable orderArgs cannot be null');
        }
        $this->container['orderArgs'] = $orderArgs;
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling MovePositionForSubAccountRequest., must be smaller than or equal to 60000.');
        }
