...
/**
 * TransferToSubAccountOfSameMasterRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class TransferToSubAccountOfSameMasterRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'transferToSubAccountOfSameMasterRequest';
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling TransferToSubAccountOfSameMasterRequest., must be smaller than or equal to 60000.');
        }
