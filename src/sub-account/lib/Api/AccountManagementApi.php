...
class AccountManagementApi
{
    ...
    public function getFuturesPositionRiskOfSubAccountRequest($email, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountManagementApi.getFuturesPositionRiskOfSubAccount, must be smaller than or equal to 60000.');
        }
    ...
    public function getFuturesPositionRiskOfSubAccountV2Request($email, $futuresType, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountManagementApi.getFuturesPositionRiskOfSubAccountV2, must be smaller than or equal to 60000.');
        }
    ...
    public function getSubAccountsStatusOnMarginOrFuturesRequest($email = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountManagementApi.getSubAccountsStatusOnMarginOrFutures, must be smaller than or equal to 60000.');
        }
     ...
     *
     * @param null|string $email      (optional)
     * @param null|string $isFreeze   (optional)
    ...
    public function querySubAccountListRequest($email = null, $isFreeze = null, $page = null, $limit = null, $recvWindow = null)
    {
        ...
        if (null !== $limit && $limit > 200) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling AccountManagementApi.querySubAccountList, must be smaller than or equal to 200.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountManagementApi.querySubAccountList, must be smaller than or equal to 60000.');
        }
    ...
    public function querySubAccountTransactionStatisticsRequest($email = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountManagementApi.querySubAccountTransactionStatistics, must be smaller than or equal to 60000.');
        }
