...
class ManagedSubAccountApi
{
    ...
    public function getManagedSubAccountDepositAddressRequest($email, $coin, $network = null, $amount = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling ManagedSubAccountApi.getManagedSubAccountDepositAddress, must be smaller than or equal to 60000.');
        }
    ...
    public function queryManagedSubAccountAssetDetailsRequest($email, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling ManagedSubAccountApi.queryManagedSubAccountAssetDetails, must be smaller than or equal to 60000.');
        }
    ...
    public function queryManagedSubAccountListRequest($email = null, $page = null, $limit = null, $recvWindow = null)
    {
        ...
        if (null !== $limit && $limit > 20) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ManagedSubAccountApi.queryManagedSubAccountList, must be smaller than or equal to 20.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling ManagedSubAccountApi.queryManagedSubAccountList, must be smaller than or equal to 60000.');
        }
    ...
    public function queryManagedSubAccountSnapshotRequest($email, $type, $startTime = null, $endTime = null, $limit = null, $recvWindow = null)
    {
        ...
        if (null !== $limit && $limit > 30) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ManagedSubAccountApi.queryManagedSubAccountSnapshot, must be smaller than or equal to 30.');
        }
        if (null !== $limit && $limit < 7) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ManagedSubAccountApi.queryManagedSubAccountSnapshot, must be bigger than or equal to 7.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling ManagedSubAccountApi.queryManagedSubAccountSnapshot, must be smaller than or equal to 60000.');
        }
     ...
     * @param null|string                      $transfers                   Transfer Direction (FROM/TO) (optional)
     * @param null|TransferFunctionAccountType $transferFunctionAccountType (optional)
     *
     * @return ApiResponse<QueryManagedSubAccountTransferLogMasterAccountInvestorResponse>
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
    ...
    public function queryManagedSubAccountTransferLogMasterAccountInvestorRequest($email, $startTime, $endTime, $page, $limit, $transfers = null, $transferFunctionAccountType = null)
    {
        ...
        if ($limit > 500) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ManagedSubAccountApi.queryManagedSubAccountTransferLogMasterAccountInvestor, must be smaller than or equal to 500.');
        }
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'TransferFunctionAccountType', // openApiType
            'form', // style
            true, // explode
            false // required
        ) ?? []);
    ...
    public function queryManagedSubAccountTransferLogMasterAccountTradingRequest($email, $startTime, $endTime, $page, $limit, $transfers = null, $transferFunctionAccountType = null)
    {
        ...
        if ($limit > 500) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ManagedSubAccountApi.queryManagedSubAccountTransferLogMasterAccountTrading, must be smaller than or equal to 500.');
        }
    ...
    public function queryManagedSubAccountTransferLogSubAccountTradingRequest($startTime, $endTime, $page, $limit, $transfers = null, $transferFunctionAccountType = null, $recvWindow = null)
    {
        ...
        if ($limit > 500) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ManagedSubAccountApi.queryManagedSubAccountTransferLogSubAccountTrading, must be smaller than or equal to 500.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling ManagedSubAccountApi.queryManagedSubAccountTransferLogSubAccountTrading, must be smaller than or equal to 60000.');
        }
