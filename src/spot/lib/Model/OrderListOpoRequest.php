...
class OrderListOpoRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param null|string $pendingClientOrderId Arbitrary unique ID among open orders for the pending order. Automatically generated if not sent.
     *
     * @return self
     */
     ...
     * Sets pendingPrice.
     *
     * @param null|float $pendingPrice price for the pending order
     *
     * @return self
     */
     ...
     *
     * @param null|float $pendingStopPrice stop price for the pending order
     *
     * @return self
     */
     ...
     *
     * @param null|float $pendingTrailingDelta trailing delta for the pending order
     *
     * @return self
     */
     ...
     *
     * @param null|float $pendingIcebergQty this can only be used if `pendingTimeInForce` is `GTC` or if `pendingType` is `LIMIT_MAKER`
     *
     * @return self
     */
     ...
     *
     * @param null|int $pendingStrategyId arbitrary numeric value identifying the pending order within an order strategy
     *
     * @return self
     */
     ...
     *
     * @param null|int $pendingStrategyType Arbitrary numeric value identifying the pending order strategy. Values smaller than `1000000` are reserved and cannot be used.
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling OrderListOpoRequest., must be smaller than or equal to 60000.');
        }
