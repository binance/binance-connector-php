...
class NewOrderRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['strategyType']) && ($this->container['strategyType'] < 1000000)) {
            $invalidProperties[] = "invalid value for 'strategyType', must be bigger than or equal to 1000000.";
        }

        if (!is_null($this->container['pegOffsetValue']) && ($this->container['pegOffsetValue'] > 100)) {
            $invalidProperties[] = "invalid value for 'pegOffsetValue', must be smaller than or equal to 100.";
        }
     ...
     *
     * @param null|string $newClientOrderId A unique id among open orders. Automatically generated if not sent.<br/> Orders with the same `newClientOrderID` can be accepted only when the previous one is filled, otherwise the order will be rejected.
     *
     * @return self
     */
    ...
    public function setStrategyType($strategyType)
    {
        ...
        if ($strategyType < 1000000) {
            throw new \InvalidArgumentException('invalid value for $strategyType when calling NewOrderRequest., must be bigger than or equal to 1000000.');
        }
     ...
     * Sets trailingDelta.
     *
     * @param null|int $trailingDelta See Trailing Stop order FAQ
     *
     * @return self
     */
     ...
     * Sets pegOffsetValue.
     *
     * @param null|int $pegOffsetValue Price level to peg the price to (max: 100). See Pegged Orders Info
     *
     * @return self
     */
    public function setPegOffsetValue($pegOffsetValue)
    {
        ...
        if ($pegOffsetValue > 100) {
            throw new \InvalidArgumentException('invalid value for $pegOffsetValue when calling NewOrderRequest., must be smaller than or equal to 100.');
        }
