...
/**
 * OrderTestRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class OrderTestRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'orderTestRequest';
     ...
     *
     * @param null|bool $computeCommissionRates default: `false` <br> See [Commissions FAQ](/products/spot/faqs/commission_faq#test-order-diferences) to learn more
     *
     * @return self
     */
     ...
     *
     * @param null|string $newClientOrderId A unique id among open orders. Automatically generated if not sent. Orders with the same `newClientOrderID` can be accepted only when the previous one is filled, otherwise the order will be rejected.
     *
     * @return self
     */
     ...
     * Sets stopPrice.
     *
     * @param null|float $stopPrice used with `STOP_LOSS`, `STOP_LOSS_LIMIT`, `TAKE_PROFIT`, and `TAKE_PROFIT_LIMIT` orders
     *
     * @return self
     */
     ...
     * Sets icebergQty.
     *
     * @param null|float $icebergQty used with `LIMIT`, `STOP_LOSS_LIMIT`, and `TAKE_PROFIT_LIMIT` to create an iceberg order
     *
     * @return self
     */
     ...
     * Sets pegOffsetValue.
     *
     * @param null|int $pegOffsetValue Price level for pegging (max: 100). See [Pegged Orders](/products/spot/faqs/pegged_orders)
     *
     * @return self
     */
