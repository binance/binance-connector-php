...
class OrderAmendKeepPriorityRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets orderId.
     *
     * @param null|int $orderId `orderId` or `origClientOrderId` must be sent
     *
     * @return self
     */
     ...
     *
     * @param null|string $origClientOrderId `orderId` or `origClientOrderId` must be sent
     *
     * @return self
     */
     ...
     *
     * @param null|string $newClientOrderId The new client order ID for the order after being amended. <br> If not sent, one will be randomly generated. <br> It is possible to reuse the current clientOrderId by sending it as the `newClientOrderId`.
     *
     * @return self
     */
     ...
     * Sets newQty.
     *
     * @param float $newQty `newQty` must be greater than 0 and less than the order's quantity
     *
     * @return self
     */
