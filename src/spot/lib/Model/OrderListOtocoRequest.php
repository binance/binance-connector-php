...
/**
 * OrderListOtocoRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class OrderListOtocoRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'orderListOtocoRequest';
     ...
     *
     * @param float $pendingQuantity sets the quantity for the pending orders
     *
     * @return self
     */
     ...
     *
     * @param null|float $pendingAboveIcebergQty this can only be used if `pendingAboveTimeInForce` is `GTC` or if `pendingAboveType` is `LIMIT_MAKER`
     *
     * @return self
     */
     ...
     *
     * @param null|float $pendingBelowIcebergQty this can only be used if `pendingBelowTimeInForce` is `GTC`, or if `pendingBelowType` is `LIMIT_MAKER`
     *
     * @return self
     */
