...
class OrderListOcoRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets quantity.
     *
     * @param float $quantity quantity for both orders of the order list
     *
     * @return self
     */
     ...
     *
     * @param null|string $aboveClientOrderId Arbitrary unique ID among open orders for the above order. Automatically generated if not sent.
     *
     * @return self
     */
     ...
     *
     * @param null|int $aboveIcebergQty note that this can only be used if `aboveTimeInForce` is `GTC`
     *
     * @return self
     */
     ...
     * Sets abovePrice.
     *
     * @param null|float $abovePrice can be used if `aboveType` is `STOP_LOSS_LIMIT`, `LIMIT_MAKER`, or `TAKE_PROFIT_LIMIT` to specify the limit price
     *
     * @return self
     */
     ...
     * Sets aboveStopPrice.
     *
     * @param null|float $aboveStopPrice Can be used if `aboveType` is `STOP_LOSS`, `STOP_LOSS_LIMIT`, `TAKE_PROFIT`, `TAKE_PROFIT_LIMIT`. Either `aboveStopPrice` or `aboveTrailingDelta` or both, must be specified.
     *
     * @return self
     */
     ...
     *
     * @param null|int $aboveTrailingDelta See [Trailing Stop order FAQ](/products/spot/faqs/trailing-stop-faq)
     *
     * @return self
     */
     ...
     *
     * @param null|int $aboveStrategyId arbitrary numeric value identifying the above order within an order strategy
     *
     * @return self
     */
     ...
     *
     * @param null|int $aboveStrategyType Arbitrary numeric value identifying the above order strategy. Values smaller than `1000000` are reserved and cannot be used.
     *
     * @return self
     */
     ...
     *
     * @param null|string $belowClientOrderId Arbitrary unique ID among open orders for the below order. Automatically generated if not sent.
     *
     * @return self
     */
     ...
     *
     * @param null|int $belowIcebergQty note that this can only be used if `belowTimeInForce` is `GTC`
     *
     * @return self
     */
     ...
     * Sets belowPrice.
     *
     * @param null|float $belowPrice can be used if `belowType` is `STOP_LOSS_LIMIT`, `LIMIT_MAKER`, or `TAKE_PROFIT_LIMIT` to specify the limit price
     *
     * @return self
     */
     ...
     * Sets belowStopPrice.
     *
     * @param null|float $belowStopPrice Can be used if `belowType` is `STOP_LOSS`, `STOP_LOSS_LIMIT`, `TAKE_PROFIT`, `TAKE_PROFIT_LIMIT`. Either `belowStopPrice` or `belowTrailingDelta` or both, must be specified.
     *
     * @return self
     */
     ...
     *
     * @param null|int $belowTrailingDelta See [Trailing Stop order FAQ](/products/spot/faqs/trailing-stop-faq)
     *
     * @return self
     */
     ...
     *
     * @param null|int $belowStrategyId arbitrary numeric value identifying the below order within an order strategy
     *
     * @return self
     */
     ...
     *
     * @param null|int $belowStrategyType Arbitrary numeric value identifying the below order strategy. Values smaller than `1000000` are reserved and cannot be used.
     *
     * @return self
     */
