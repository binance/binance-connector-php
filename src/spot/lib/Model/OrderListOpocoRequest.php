...
class OrderListOpocoRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param null|string $workingClientOrderId Arbitrary unique ID among open orders for the working order. Automatically generated if not sent.
     *
     * @return self
     */
     ...
     * Sets workingPrice.
     *
     * @param float $workingPrice price for the working order
     *
     * @return self
     */
     ...
     *
     * @param float $workingQuantity sets the quantity for the working order
     *
     * @return self
     */
     ...
     *
     * @param null|float $workingIcebergQty this can only be used if `workingTimeInForce` is `GTC`, or if `workingType` is `LIMIT_MAKER`
     *
     * @return self
     */
     ...
     *
     * @param null|int $workingStrategyId arbitrary numeric value identifying the working order within an order strategy
     *
     * @return self
     */
     ...
     *
     * @param null|int $workingStrategyType Arbitrary numeric value identifying the working order strategy. Values smaller than `1000000` are reserved and cannot be used.
     *
     * @return self
     */
     ...
     *
     * @param null|int $workingPegOffsetValue Price level for pegging (max: 100). See [Pegged Orders](/products/spot/faqs/pegged_orders)
     *
     * @return self
     */
     ...
     *
     * @param null|string $pendingAboveClientOrderId Arbitrary unique ID among open orders for the pending above order. Automatically generated if not sent.
     *
     * @return self
     */
     ...
     *
     * @param null|float $pendingAbovePrice can be used if `pendingAboveType` is `STOP_LOSS_LIMIT`, `LIMIT_MAKER`, or `TAKE_PROFIT_LIMIT` to specify the limit price
     *
     * @return self
     */
     ...
     *
     * @param null|float $pendingAboveStopPrice can be used if `pendingAboveType` is `STOP_LOSS`, `STOP_LOSS_LIMIT`, `TAKE_PROFIT`, `TAKE_PROFIT_LIMIT`
     *
     * @return self
     */
     ...
     *
     * @param null|float $pendingAboveTrailingDelta See [Trailing Stop order FAQ](/products/spot/faqs/trailing-stop-faq)
     *
     * @return self
     */
     ...
     *
     * @param null|float $pendingAboveIcebergQty this can only be used if `pendingAboveTimeInForce` is `GTC` or `pendingAboveType` is `LIMIT_MAKER`
     *
     * @return self
     */
     ...
     *
     * @param null|int $pendingAboveStrategyId arbitrary numeric value identifying the pending above order within an order strategy
     *
     * @return self
     */
     ...
     *
     * @param null|int $pendingAboveStrategyType Arbitrary numeric value identifying the pending above order strategy. Values smaller than `1000000` are reserved and cannot be used.
     *
     * @return self
     */
     ...
     *
     * @param null|int $pendingAbovePegOffsetValue Price level for pegging (max: 100). See [Pegged Orders](/products/spot/faqs/pegged_orders)
     *
     * @return self
     */
     ...
     *
     * @param null|string $pendingBelowClientOrderId Arbitrary unique ID among open orders for the pending below order. Automatically generated if not sent.
     *
     * @return self
     */
     ...
     *
     * @param null|float $pendingBelowPrice can be used if `pendingBelowType` is `STOP_LOSS_LIMIT` or `TAKE_PROFIT_LIMIT` to specify the limit price
     *
     * @return self
     */
     ...
     *
     * @param null|float $pendingBelowStopPrice Can be used if `pendingBelowType` is `STOP_LOSS`, `STOP_LOSS_LIMIT`, `TAKE_PROFIT`, `TAKE_PROFIT_LIMIT`. Either `pendingBelowStopPrice` or `pendingBelowTrailingDelta` or both, must be specified.
     *
     * @return self
     */
     ...
     *
     * @param null|float $pendingBelowTrailingDelta See [Trailing Stop order FAQ](/products/spot/faqs/trailing-stop-faq)
     *
     * @return self
     */
     ...
     *
     * @param null|float $pendingBelowIcebergQty this can only be used if `pendingBelowTimeInForce` is `GTC` or `pendingBelowType` is `LIMIT_MAKER`
     *
     * @return self
     */
     ...
     *
     * @param null|int $pendingBelowStrategyId arbitrary numeric value identifying the pending below order within an order strategy
     *
     * @return self
     */
     ...
     *
     * @param null|int $pendingBelowStrategyType Arbitrary numeric value identifying the pending below order strategy. Values smaller than `1000000` are reserved and cannot be used.
     *
     * @return self
     */
     ...
     * Sets recvWindow.
     *
     * @param null|float $recvWindow The value cannot be greater than `60000`. Supports up to three decimal places of precision (e.g., 6000.346) so that microseconds may be specified.
     *
     * @return self
     */
