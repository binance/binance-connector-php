...
/**
 * DeleteOrderResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class DeleteOrderResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'deleteOrderResponse';
     ...
     * Sets icebergQty.
     *
     * @param null|string $icebergQty Quantity for the iceberg order. Appears only if the parameter `icebergQty` was sent in the request.
     *
     * @return self
     */
     ...
     *
     * @param null|int $preventedMatchId When used together with `symbol`, can be used to query a prevented match. Appears only if the order expired due to STP.
     *
     * @return self
     */
     ...
     *
     * @param null|string $preventedQuantity Order quantity that expired due to STP. Appears only if the order expired due to STP.
     *
     * @return self
     */
     ...
     * Sets stopPrice.
     *
     * @param null|string $stopPrice Price when the algorithmic order will be triggered. Appears for `STOP_LOSS`, `TAKE_PROFIT`, `STOP_LOSS_LIMIT`, and `TAKE_PROFIT_LIMIT` orders.
     *
     * @return self
     */
     ...
     * Sets strategyId.
     *
     * @param null|int $strategyId Can be used to label an order that's part of an order strategy. Appears if the parameter was populated in the request.
     *
     * @return self
     */
     ...
     * Sets strategyType.
     *
     * @param null|int $strategyType Can be used to label an order that is using an order strategy. Appears if the parameter was populated in the request.
     *
     * @return self
     */
     ...
     * Sets trailingDelta.
     *
     * @param null|int $trailingDelta Delta price change required before order activation. Appears for trailing stop orders.
     *
     * @return self
     */
     ...
     * Sets trailingTime.
     *
     * @param null|int $trailingTime Time when the trailing order becomes active and starts tracking price changes. Appears only for trailing stop orders.
     *
     * @return self
     */
     ...
     * Sets usedSor.
     *
     * @param null|bool $usedSor Indicates whether the order used SOR. Appears when placing orders using SOR.
     *
     * @return self
     */
     ...
     * Sets workingFloor.
     *
     * @param null|string $workingFloor Indicates whether the order is being filled by SOR or by the order book to which it was submitted. Appears when placing orders using SOR.
     *
     * @return self
     */
     ...
     * Sets peggedPrice.
     *
     * @param null|string $peggedPrice Current price the order is pegged at. Only for pegged orders, once determined.
     *
     * @return self
     */
     ...
     * Sets expiryReason.
     *
     * @param null|string $expiryReason Cause of the order's expiration. Returned when an order has expired.
     *
     * @return self
     */
