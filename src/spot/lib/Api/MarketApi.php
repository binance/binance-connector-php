...
class MarketApi
{
    ...
    public const contentTypes = [
        ...
        'historicalBlockTrades' => ['application/x-www-form-urlencoded'],
    ...
    public function aggTradesRequest($symbol, $fromId = null, $startTime = null, $endTime = null, $limit = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling MarketApi.aggTrades, must be smaller than or equal to 1000.');
        }
    ...
    public function depthRequest($symbol, $limit = null, $symbolStatus = null)
    {
        ...
        if (null !== $limit && $limit > 5000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling MarketApi.depth, must be smaller than or equal to 5000.');
        }
    ...
    public function getTradesRequest($symbol, $limit = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling MarketApi.getTrades, must be smaller than or equal to 1000.');
        }
    ...
    {
        return $this->historicalBlockTradesWithHttpInfo($symbol, $fromId, $limit);
    }

    /**
     * Operation historicalBlockTradesWithHttpInfo.
     *
     * Historical Block Trades (MARKET_DATA)
     *
     * @param string   $symbol (required)
     ...
     * @throws \InvalidArgumentException
     */
    public function historicalBlockTradesWithHttpInfo($symbol, $fromId, $limit = null): ApiResponse
    {
        $request = $this->historicalBlockTradesRequest($symbol, $fromId, $limit);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Binance\Client\Spot\Model\HistoricalBlockTradesResponse',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Create request for operation 'historicalBlockTrades'.
     *
     * @param string   $symbol (required)
     * @param int      $fromId Block trade ID to fetch from (required)
     * @param null|int $limit  Default: 500; Maximum: 1000 (optional)
     ...
     * @throws \InvalidArgumentException
     */
    public function historicalBlockTradesRequest($symbol, $fromId, $limit = null)
    {
        $contentType = self::contentTypes['historicalBlockTrades'][0];

        // verify the required parameter 'symbol' is set
        if (null === $symbol || (is_array($symbol) && 0 === count($symbol))) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $symbol when calling historicalBlockTrades'
            );
        }

        // verify the required parameter 'fromId' is set
        if (null === $fromId || (is_array($fromId) && 0 === count($fromId))) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $fromId when calling historicalBlockTrades'
            );
        }

        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling MarketApi.historicalBlockTrades, must be smaller than or equal to 1000.');
        }

        $resourcePath = '/api/v3/historicalBlockTrades';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function historicalTradesRequest($symbol, $limit = null, $fromId = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling MarketApi.historicalTrades, must be smaller than or equal to 1000.');
        }
    ...
    public function klinesRequest($symbol, $interval, $startTime = null, $endTime = null, $timeZone = null, $limit = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling MarketApi.klines, must be smaller than or equal to 1000.');
        }
    ...
    public function uiKlinesRequest($symbol, $interval, $startTime = null, $endTime = null, $timeZone = null, $limit = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling MarketApi.uiKlines, must be smaller than or equal to 1000.');
        }
