...
class TradeApi
{
    ...
    public function deleteOpenOrdersRequest($symbol, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.deleteOpenOrders, must be smaller than or equal to 60000.');
        }
    ...
    public function deleteOrderRequest($symbol, $orderId = null, $origClientOrderId = null, $newClientOrderId = null, $cancelRestrictions = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.deleteOrder, must be smaller than or equal to 60000.');
        }
    ...
    public function deleteOrderListRequest($symbol, $orderListId = null, $listClientOrderId = null, $newClientOrderId = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.deleteOrderList, must be smaller than or equal to 60000.');
        }
