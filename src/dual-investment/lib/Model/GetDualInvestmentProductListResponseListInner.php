...
class GetDualInvestmentProductListResponseListInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets canPurchase.
     *
     * @param null|bool $canPurchase Whether the product can be subscribed to currently
     *
     * @return self
     */
     ...
     *
     * @param null|bool $isAutoCompoundEnable Whether auto-compound is enabled for this product
     *
     * @return self
     */
     ...
     *
     * @param null|string[] $autoCompoundPlanList Available auto-compound plans for this product
     *
     * @return self
     */
