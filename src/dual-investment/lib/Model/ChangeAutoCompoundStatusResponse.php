...
/**
 * ChangeAutoCompoundStatusResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class ChangeAutoCompoundStatusResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'changeAutoCompoundStatusResponse';
     ...
     *
     * @param null|string $autoCompoundPlan Auto-compound plan after the update
     *
     * @return self
     */
