...
/**
 * SubscribeDualInvestmentProductsRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class SubscribeDualInvestmentProductsRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'subscribeDualInvestmentProductsRequest';
    ...
    protected static $openAPITypes = [
        ...
        'orderId' => 'string',
        'depositAmount' => 'float',
        'autoCompoundPlan' => '\Binance\Client\DualInvestment\Model\AutoCompoundPlan',
        'recvWindow' => 'int',
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['orderId']) {
            $invalidProperties[] = "'orderId' can't be null";
        }
        if (null === $this->container['depositAmount']) {
            $invalidProperties[] = "'depositAmount' can't be null";
        }
        if (null === $this->container['autoCompoundPlan']) {
            $invalidProperties[] = "'autoCompoundPlan' can't be null";
        }
     ...
     * Sets depositAmount.
     *
     * @param float $depositAmount the amount for subscribing
     *
     * @return self
     */
     ...
     *
     * @param AutoCompoundPlan $autoCompoundPlan autoCompoundPlan
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling SubscribeDualInvestmentProductsRequest., must be smaller than or equal to 60000.');
        }
