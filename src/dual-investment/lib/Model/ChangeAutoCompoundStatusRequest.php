...
/**
 * ChangeAutoCompoundStatusRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class ChangeAutoCompoundStatusRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'changeAutoCompoundStatusRequest';
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling ChangeAutoCompoundStatusRequest., must be smaller than or equal to 60000.');
        }
