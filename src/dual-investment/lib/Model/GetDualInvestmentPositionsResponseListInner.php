...
class GetDualInvestmentPositionsResponseListInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'subscriptionTime' => 'setSubscriptionTime',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('subscriptionTime', $data ?? [], null);
    }
     ...
     * Sets id.
     *
     * @param null|string $id positionId
     *
     * @return self
     */
     ...
     * Sets purchaseStatus.
     *
     * @param null|string $purchaseStatus Purchase status. Possible values include PENDING, PURCHASE_SUCCESS, SETTLED, PURCHASE_FAIL, REFUNDING, REFUND_SUCCESS, and SETTLING.
     *
     * @return self
     */
     ...
     *
     * @param null|string $autoCompoundPlan NULL, STANDARD, ADVANCED
     *
     * @return self
     */
    ...
    /**
     * Gets subscriptionTime.
     *
     * @return null|int
     */
    public function getSubscriptionTime()
    {
        return $this->container['subscriptionTime'];
    }

    /**
     * Sets subscriptionTime.
     *
     * @param null|int $subscriptionTime subscriptionTime
     *
     * @return self
     */
    public function setSubscriptionTime($subscriptionTime)
    {
        if (is_null($subscriptionTime)) {
            throw new \InvalidArgumentException('non-nullable subscriptionTime cannot be null');
        }
        $this->container['subscriptionTime'] = $subscriptionTime;
