...
class MarketDataApi
{
    ...
    public function getDualInvestmentProductListRequest($optionType, $exercisedCoin, $investCoin, $pageSize = null, $pageIndex = null, $recvWindow = null)
    {
        ...
        if (null !== $pageSize && $pageSize > 100) {
            throw new \InvalidArgumentException('invalid value for "$pageSize" when calling MarketDataApi.getDualInvestmentProductList, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling MarketDataApi.getDualInvestmentProductList, must be smaller than or equal to 60000.');
        }
