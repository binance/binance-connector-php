...
class MarketMakerEndpointsApi
{
     ...
     * @throws \InvalidArgumentException
     */
    public function getMarketMakerProtectionConfigWithHttpInfo($underlying, $recvWindow = null): ApiResponse
    {
     ...
     * @throws \InvalidArgumentException
     */
    public function getMarketMakerProtectionConfigRequest($underlying, $recvWindow = null)
    {
        ...
        if (null === $underlying || (is_array($underlying) && 0 === count($underlying))) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $underlying when calling getMarketMakerProtectionConfig'
            );
        }
