...
class TradeApi
{
    ...
    public const contentTypes = [
        ...
        'tradfiOptionsContract' => ['application/x-www-form-urlencoded'],
     ...
     * @throws \InvalidArgumentException
     */
    public function accountTradeListWithHttpInfo($symbol, $fromId = null, $startTime = null, $endTime = null, $limit = null, $recvWindow = null): ApiResponse
    {
     ...
     * @throws \InvalidArgumentException
     */
    public function accountTradeListRequest($symbol, $fromId = null, $startTime = null, $endTime = null, $limit = null, $recvWindow = null)
    {
    ...
    public function queryOptionOrderHistoryRequest($symbol, $orderId = null, $startTime = null, $endTime = null, $limit = null, $recvWindow = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling TradeApi.queryOptionOrderHistory, must be smaller than or equal to 1000.');
        }
    ...
    {
        return $this->tradfiOptionsContractWithHttpInfo($tradfiOptionsContractRequest);
    }

    /**
     * Operation tradfiOptionsContractWithHttpInfo.
     *
     * TradFi Options Contract (USER_DATA)
     *
     * @param null|TradfiOptionsContractRequest $tradfiOptionsContractRequest (optional)
     *
     * @return ApiResponse<TradfiOptionsContractResponse>
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function tradfiOptionsContractWithHttpInfo($tradfiOptionsContractRequest = null): ApiResponse
    {
        $request = $this->tradfiOptionsContractRequest($tradfiOptionsContractRequest);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Binance\Client\DerivativesTradingOptions\Model\TradfiOptionsContractResponse',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Create request for operation 'tradfiOptionsContract'.
     *
     * @param null|TradfiOptionsContractRequest $tradfiOptionsContractRequest (optional)
     *
     * @return Request
     ...
     * @throws \InvalidArgumentException
     */
    public function tradfiOptionsContractRequest($tradfiOptionsContractRequest = null)
    {
        $contentType = self::contentTypes['tradfiOptionsContract'][0];

        $resourcePath = '/eapi/v1/stock/contract';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $getters = $tradfiOptionsContractRequest::getters();
        $formParams = [];
        foreach ($getters as $property => $getter) {
            $value = $tradfiOptionsContractRequest->{$getter}();
            if (!empty($value)) {
                $formParams[$property] = $tradfiOptionsContractRequest->{$getter}();
            }
        }
        ...
        } elseif (isset($tradfiOptionsContractRequest)) {
            if (false !== stripos($headers['Content-Type'], 'application/json')) {
                // if Content-Type contains "application/json", json_encode the body
                $httpBody = Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($tradfiOptionsContractRequest));
            } else {
                $httpBody = $tradfiOptionsContractRequest;
            }
        }
    ...
    public function userExerciseRecordRequest($symbol = null, $startTime = null, $endTime = null, $limit = null, $recvWindow = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling TradeApi.userExerciseRecord, must be smaller than or equal to 1000.');
        }
