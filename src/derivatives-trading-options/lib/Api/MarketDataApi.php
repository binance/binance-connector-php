...
class MarketDataApi
{
    ...
    public function historicalExerciseRecordsRequest($underlying = null, $startTime = null, $endTime = null, $limit = null)
    {
        ...
        if (null !== $limit && $limit > 100) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling MarketDataApi.historicalExerciseRecords, must be smaller than or equal to 100.');
        }
    ...
    public function recentBlockTradesListRequest($symbol = null, $limit = null)
    {
        ...
        if (null !== $limit && $limit > 500) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling MarketDataApi.recentBlockTradesList, must be smaller than or equal to 500.');
        }
    ...
    public function recentTradesListRequest($symbol, $limit = null)
    {
        ...
        if (null !== $limit && $limit > 500) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling MarketDataApi.recentTradesList, must be smaller than or equal to 500.');
        }
