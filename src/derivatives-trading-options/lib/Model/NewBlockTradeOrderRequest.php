...
/**
 * NewBlockTradeOrderRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class NewBlockTradeOrderRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'newBlockTradeOrderRequest';
    ...
    protected static $openAPITypes = [
        'liquidity' => '\Binance\Client\DerivativesTradingOptions\Model\Liquidity',
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['liquidity']) {
     ...
     * Sets liquidity.
     *
     * @param Liquidity $liquidity liquidity
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling NewBlockTradeOrderRequest., must be smaller than or equal to 60000.');
        }
