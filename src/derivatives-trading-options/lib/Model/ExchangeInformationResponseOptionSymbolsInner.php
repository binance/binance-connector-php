...
class ExchangeInformationResponseOptionSymbolsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('nakedSell', $data ?? [], null);
     ...
     * Sets expiryDate.
     *
     * @param null|int $expiryDate expiry time
     *
     * @return self
     */
     ...
     * Sets symbol.
     *
     * @param null|string $symbol Trading pair name
     *
     * @return self
     */
     ...
     * Sets side.
     *
     * @param null|string $side Direction: CALL long, PUT short
     *
     * @return self
     */
     ...
     * Sets strikePrice.
     *
     * @param null|string $strikePrice Strike price
     *
     * @return self
     */
     ...
     * Sets underlying.
     *
     * @param null|string $underlying Name of the underlying asset of the option contract
     *
     * @return self
     */
     ...
     * Sets unit.
     *
     * @param null|int $unit contract unit, the quantity of the underlying asset represented by a single contract
     *
     * @return self
     */
     ...
     *
     * @param null|string $liquidationFeeRate liquidation fee rate
     *
     * @return self
     */
     ...
     * Sets minQty.
     *
     * @param null|string $minQty Minimum order quantity
     *
     * @return self
     */
     ...
     * Sets maxQty.
     *
     * @param null|string $maxQty Maximum order quantity
     *
     * @return self
     */
     ...
     * Sets initialMargin.
     *
     * @param null|string $initialMargin Initial Magin Ratio
     *
     * @return self
     */
     ...
     *
     * @param null|string $maintenanceMargin Maintenance Margin Ratio
     *
     * @return self
     */
     ...
     *
     * @param null|string $minInitialMargin Min Initial Margin Ratio
     *
     * @return self
     */
     ...
     *
     * @param null|string $minMaintenanceMargin Min Maintenance Margin Ratio
     *
     * @return self
     */
     ...
     * Sets priceScale.
     *
     * @param null|int $priceScale price precision
     *
     * @return self
     */
     ...
     * Sets quantityScale.
     *
     * @param null|int $quantityScale quantity precision
     *
     * @return self
     */
     ...
     * Sets quoteAsset.
     *
     * @param null|string $quoteAsset Quotation asset
     *
     * @return self
     */
     ...
     * Sets underlyingType.
     *
     * @param null|string $underlyingType Underlying type
     *
     * @return self
     */
     ...
     * @return null|bool
     */
    public function getNakedSell()
    {
        return $this->container['nakedSell'];
    }

    /**
     * Sets nakedSell.
     *
     * @param null|bool $nakedSell Whether naked selling is allowed for this symbol
     *
     * @return self
     */
    public function setNakedSell($nakedSell)
    {
        if (is_null($nakedSell)) {
            throw new \InvalidArgumentException('non-nullable nakedSell cannot be null');
        }
        $this->container['nakedSell'] = $nakedSell;
     ...
     * Sets status.
     *
     * @param null|string $status Trading Status
     *
     * @return self
     */
