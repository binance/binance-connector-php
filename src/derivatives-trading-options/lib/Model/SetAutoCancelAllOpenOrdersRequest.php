...
/**
 * SetAutoCancelAllOpenOrdersRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class SetAutoCancelAllOpenOrdersRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'setAutoCancelAllOpenOrdersRequest';
     ...
     * Sets countdownTime.
     *
     * @param int $countdownTime Countdown time in milliseconds (ex. 1,000 for 1 second). 0 to disable the timer. Negative values (ex. -10000) are not accepted. Minimum acceptable value is 5,000
     *
     * @return self
     */
