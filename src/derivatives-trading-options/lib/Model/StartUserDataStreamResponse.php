...
/**
 * StartUserDataStreamResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class StartUserDataStreamResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'startUserDataStreamResponse';
     ...
     * Sets listenKey.
     *
     * @param null|string $listenKey listen Key
     *
     * @return self
     */
     ...
     * Sets expiration.
     *
     * @param null|int $expiration Listen key expiration timestamp in milliseconds
     *
     * @return self
     */
