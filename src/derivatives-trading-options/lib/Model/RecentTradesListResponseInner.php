...
class RecentTradesListResponseInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets price.
     *
     * @param null|string $price Completed trade price
     *
     * @return self
     */
     ...
     * Sets qty.
     *
     * @param null|string $qty Completed trade quantity
     *
     * @return self
     */
     ...
     * Sets quoteQty.
     *
     * @param null|string $quoteQty Completed trade amount
     *
     * @return self
     */
     ...
     * Sets side.
     *
     * @param null|int $side Completed trade direction（-1 Sell，1 Buy）
     *
     * @return self
     */
