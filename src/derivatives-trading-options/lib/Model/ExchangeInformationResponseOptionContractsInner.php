...
/**
 * ExchangeInformationResponseOptionContractsInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class ExchangeInformationResponseOptionContractsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'exchangeInformationResponse_optionContracts_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('settleAsset', $data ?? [], null);
    }
     ...
     * Sets baseAsset.
     *
     * @param null|string $baseAsset Base currency
     *
     * @return self
     */
     ...
     * @return null|string
     */
    public function getSettleAsset()
    {
        return $this->container['settleAsset'];
    }

    /**
     * Sets settleAsset.
     *
     * @param null|string $settleAsset Settlement currency
     *
     * @return self
     */
    public function setSettleAsset($settleAsset)
    {
        if (is_null($settleAsset)) {
            throw new \InvalidArgumentException('non-nullable settleAsset cannot be null');
        }
        $this->container['settleAsset'] = $settleAsset;
