...
class Ticker24hrPriceChangeStatisticsResponseInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets priceChange.
     *
     * @param null|string $priceChange 24-hour price change
     *
     * @return self
     */
     ...
     *
     * @param null|string $priceChangePercent 24-hour percent price change
     *
     * @return self
     */
     ...
     * Sets lastPrice.
     *
     * @param null|string $lastPrice Last trade price
     *
     * @return self
     */
     ...
     * Sets lastQty.
     *
     * @param null|string $lastQty Last trade amount
     *
     * @return self
     */
     ...
     * Sets open.
     *
     * @param null|string $open 24-hour open price
     *
     * @return self
     */
     ...
     * Sets high.
     *
     * @param null|string $high 24-hour high
     *
     * @return self
     */
     ...
     * Sets low.
     *
     * @param null|string $low 24-hour low
     *
     * @return self
     */
     ...
     * Sets volume.
     *
     * @param null|string $volume Trading volume(contracts)
     *
     * @return self
     */
     ...
     * Sets amount.
     *
     * @param null|string $amount Trade amount(in quote asset)
     *
     * @return self
     */
     ...
     * Sets bidPrice.
     *
     * @param null|string $bidPrice The best buy price
     *
     * @return self
     */
     ...
     * Sets askPrice.
     *
     * @param null|string $askPrice The best sell price
     *
     * @return self
     */
     ...
     * Sets openTime.
     *
     * @param null|int $openTime Time the first trade occurred within the last 24 hours
     *
     * @return self
     */
     ...
     * Sets closeTime.
     *
     * @param null|int $closeTime Time the last trade occurred within the last 24 hours
     *
     * @return self
     */
     ...
     * Sets firstTradeId.
     *
     * @param null|int $firstTradeId First trade ID
     *
     * @return self
     */
     ...
     * Sets tradeCount.
     *
     * @param null|int $tradeCount Number of trades
     *
     * @return self
     */
     ...
     * Sets exercisePrice.
     *
     * @param null|string $exercisePrice return estimated settlement price one hour before exercise, return index price at other times
     *
     * @return self
     */
