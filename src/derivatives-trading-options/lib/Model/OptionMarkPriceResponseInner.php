...
class OptionMarkPriceResponseInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets bidIV.
     *
     * @param null|string $bidIV Implied volatility Buy
     *
     * @return self
     */
     ...
     * Sets askIV.
     *
     * @param null|string $askIV Implied volatility Sell
     *
     * @return self
     */
     ...
     * Sets markIV.
     *
     * @param null|string $markIV Implied volatility mark
     *
     * @return self
     */
     ...
     * Sets highPriceLimit.
     *
     * @param null|string $highPriceLimit Current highest buy price
     *
     * @return self
     */
     ...
     * Sets lowPriceLimit.
     *
     * @param null|string $lowPriceLimit Current lowest sell price
     *
     * @return self
     */
     ...
     *
     * @param null|string $riskFreeInterest risk free rate
     *
     * @return self
     */
