# Migration Guide: Binance Alpha Connector Modularization
...
1. **Package Name**:  
   The modularised Alpha Connector has been moved to a new package:
...
4. **Configuration and Client Initialization**:  
   The new structure keeps the existing configuration options but modularized clients into `AlphaRestApi`.
