...
class GetExchangeInfoResponseDataSymbolsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets pricePrecision.
     *
     * @param null|int $pricePrecision allowed precision for price
     *
     * @return self
     */
     ...
     *
     * @param null|int $quantityPrecision allowed precision for quantity
     *
     * @return self
     */
     ...
     * Sets filters.
     *
     * @param null|GetExchangeInfoResponseDataSymbolsInnerFiltersInner[] $filters trading filters and constraints
     *
     * @return self
     */
     ...
     * Sets orderTypes.
     *
     * @param null|string[] $orderTypes supported order types for this symbol
     *
     * @return self
     */
