...
class DefaultApi
{
    ...
    {
        return $this->getC2CTradeHistoryWithHttpInfo($tradeType, $startTimestamp, $endTimestamp, $page, $rows);
    }
     ...
     * @throws \InvalidArgumentException
     */
    public function getC2CTradeHistoryWithHttpInfo($tradeType = null, $startTimestamp = null, $endTimestamp = null, $page = null, $rows = null): ApiResponse
    {
        $request = $this->getC2CTradeHistoryRequest($tradeType, $startTimestamp, $endTimestamp, $page, $rows);
     ...
     * @throws \InvalidArgumentException
     */
    public function getC2CTradeHistoryRequest($tradeType = null, $startTimestamp = null, $endTimestamp = null, $page = null, $rows = null)
    {
        $contentType = self::contentTypes['getC2CTradeHistory'][0];

        if (null !== $rows && $rows > 100) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling DefaultApi.getC2CTradeHistory, must be smaller than or equal to 100.');
        }
