...
class GetC2CTradeHistoryResponseDataInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets amount.
     *
     * @param null|string $amount Quantity (in Crypto)
     *
     * @return self
     */
     ...
     * Sets totalPrice.
     *
     * @param null|string $totalPrice Total order amount in fiat
     *
     * @return self
     */
     ...
     * Sets unitPrice.
     *
     * @param null|string $unitPrice Unit Price (in Fiat)
     *
     * @return self
     */
     ...
     * Sets createTime.
     *
     * @param null|int $createTime Order creation timestamp in milliseconds
     *
     * @return self
     */
     ...
     *
     * @param null|string $counterPartNickName Counterparty nickname
     *
     * @return self
     */
     ...
     * Sets payMethodName.
     *
     * @param null|string $payMethodName Identifier of the payment method
     *
     * @return self
     */
     ...
     *
     * @param null|int $additionalKycVerify KYC verification status. 0: not required, 1: not verified, 2: verified
     *
     * @return self
     */
     ...
     *
     * @param null|string $takerCommission Taker commission amount
     *
     * @return self
     */
     ...
     * Sets takerAmount.
     *
     * @param null|string $takerAmount Taker trade amount
     *
     * @return self
     */
