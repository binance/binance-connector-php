...
class AccountApi
{
     ...
     * Fund Auto-collection (TRADE)
     *
     * @param null|FundAutoCollectionRequest $fundAutoCollectionRequest (optional)
     *
     * @return ApiResponse<FundAutoCollectionResponse>
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function fundAutoCollectionWithHttpInfo($fundAutoCollectionRequest = null): ApiResponse
    {
     ...
     * @throws \InvalidArgumentException
     */
    public function fundAutoCollectionRequest($fundAutoCollectionRequest = null)
    {
     ...
     *
     * @param null|string     $symbol     (optional)
     * @param null|IncomeType $incomeType (optional)
     * @param null|int        $startTime  Timestamp in ms to get funding from INCLUSIVE. (optional)
     * @param null|int        $endTime    Timestamp in ms to get funding until INCLUSIVE. (optional)
    ...
    public function getCmIncomeHistoryRequest($symbol = null, $incomeType = null, $startTime = null, $endTime = null, $page = null, $limit = null, $recvWindow = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling AccountApi.getCmIncomeHistory, must be smaller than or equal to 1000.');
        }
    ...
    public function getMarginBorrowLoanInterestHistoryRequest($asset = null, $startTime = null, $endTime = null, $current = null, $size = null, $archived = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling AccountApi.getMarginBorrowLoanInterestHistory, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling AccountApi.getMarginBorrowLoanInterestHistory, must be smaller than or equal to 100.');
        }
    ...
    public function getUmIncomeHistoryRequest($symbol = null, $incomeType = null, $startTime = null, $endTime = null, $page = null, $limit = null, $recvWindow = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling AccountApi.getUmIncomeHistory, must be smaller than or equal to 1000.');
        }
    ...
    public function queryMarginLoanRecordRequest($asset, $txId = null, $startTime = null, $endTime = null, $current = null, $size = null, $archived = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling AccountApi.queryMarginLoanRecord, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling AccountApi.queryMarginLoanRecord, must be smaller than or equal to 100.');
        }
    ...
    public function queryMarginMaxWithdrawRequest($asset, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.queryMarginMaxWithdraw, must be smaller than or equal to 60000.');
        }
    ...
    public function queryMarginRepayRecordRequest($asset, $txId = null, $startTime = null, $endTime = null, $current = null, $size = null, $archived = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling AccountApi.queryMarginRepayRecord, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling AccountApi.queryMarginRepayRecord, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.queryMarginRepayRecord, must be smaller than or equal to 60000.');
        }
    ...
    public function queryPortfolioMarginNegativeBalanceInterestHistoryRequest($asset = null, $startTime = null, $endTime = null, $size = null, $recvWindow = null)
    {
        ...
        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling AccountApi.queryPortfolioMarginNegativeBalanceInterestHistory, must be smaller than or equal to 100.');
        }
    ...
    public function queryUserNegativeBalanceAutoExchangeRecordRequest($startTime, $endTime, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.queryUserNegativeBalanceAutoExchangeRecord, must be smaller than or equal to 60000.');
        }
     ...
     * Repay futures Negative Balance (USER_DATA)
     *
     * @param null|RepayFuturesNegativeBalanceRequest $repayFuturesNegativeBalanceRequest (optional)
     *
     * @return ApiResponse<RepayFuturesNegativeBalanceResponse>
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function repayFuturesNegativeBalanceWithHttpInfo($repayFuturesNegativeBalanceRequest = null): ApiResponse
    {
     ...
     * @throws \InvalidArgumentException
     */
    public function repayFuturesNegativeBalanceRequest($repayFuturesNegativeBalanceRequest = null)
    {
