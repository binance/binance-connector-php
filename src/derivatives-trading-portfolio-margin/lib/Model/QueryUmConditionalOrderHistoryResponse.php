...
/**
 * QueryUmConditionalOrderHistoryResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class QueryUmConditionalOrderHistoryResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'queryUmConditionalOrderHistoryResponse';
     ...
     *
     * @param null|string $newClientStrategyId new Client Strategy ID
     *
     * @return self
     */
     ...
     * Sets strategyId.
     *
     * @param null|int $strategyId strategy ID
     *
     * @return self
     */
     ...
     * Sets strategyStatus.
     *
     * @param null|string $strategyStatus strategy Status
     *
     * @return self
     */
     ...
     * Sets strategyType.
     *
     * @param null|string $strategyType strategy Type
     *
     * @return self
     */
     ...
     * Sets reduceOnly.
     *
     * @param null|bool $reduceOnly reduce Only
     *
     * @return self
     */
     ...
     * Sets positionSide.
     *
     * @param null|string $positionSide BOTH means that it is the position of One-way Mode
     *
     * @return self
     */
     ...
     * Sets stopPrice.
     *
     * @param null|string $stopPrice please ignore when order type is TRAILING_STOP_MARKET
     *
     * @return self
     */
     ...
     * Sets status.
     *
     * @param null|string $status Normal order status after trigger if appliable, only have when the strategy is triggered
     *
     * @return self
     */
     ...
     * Sets bookTime.
     *
     * @param null|int $bookTime order time
     *
     * @return self
     */
     ...
     * Sets triggerTime.
     *
     * @param null|int $triggerTime trigger Time
     *
     * @return self
     */
     ...
     * Sets activatePrice.
     *
     * @param null|string $activatePrice activation price, only return with TRAILING_STOP_MARKET order
     *
     * @return self
     */
     ...
     * Sets priceRate.
     *
     * @param null|string $priceRate callback rate, only return with TRAILING_STOP_MARKET order
     *
     * @return self
     */
     ...
     * Sets workingType.
     *
     * @param null|string $workingType working Type
     *
     * @return self
     */
     ...
     * Sets priceProtect.
     *
     * @param null|bool $priceProtect price Protect
     *
     * @return self
     */
     ...
     *
     * @param null|string $selfTradePreventionMode self trading preventation mode
     *
     * @return self
     */
     ...
     * Sets goodTillDate.
     *
     * @param null|int $goodTillDate order pre-set auot cancel time for TIF GTD order
     *
     * @return self
     */
