...
/**
 * NewUmAlgoOrderRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class NewUmAlgoOrderRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'newUmAlgoOrderRequest';
    ...
    protected static $openAPITypes = [
        'algoType' => '\Binance\Client\DerivativesTradingPortfolioMargin\Model\AlgoType',
        'symbol' => 'string',
        ...
        'type' => '\Binance\Client\DerivativesTradingPortfolioMargin\Model\OrderType',
     ...
     * Sets activatePrice.
     *
     * @param null|float $activatePrice Used with `TRAILING_STOP_MARKET`, default as latest price
     *
     * @return self
     */
     ...
     * Sets callbackRate.
     *
     * @param null|float $callbackRate Used with `TRAILING_STOP_MARKET`, min 0.1, max 10 (1 = 1%)
     *
     * @return self
     */
     ...
     * Sets clientAlgoId.
     *
     * @param null|string $clientAlgoId Unique id among open orders. Auto-generated if not sent
     *
     * @return self
     */
     ...
     * Sets goodTillDate.
     *
     * @param null|int $goodTillDate Order cancel time for `GTD` timeInForce, mandatory when timeInForce is `GTD`
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling NewUmAlgoOrderRequest., must be smaller than or equal to 60000.');
        }
