...
/**
 * ToggleBnbBurnOnUmFuturesTradeRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class ToggleBnbBurnOnUmFuturesTradeRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'toggleBnbBurnOnUmFuturesTradeRequest';
    ...
    protected static $openAPITypes = [
        'feeBurn' => '\Binance\Client\DerivativesTradingPortfolioMargin\Model\FeeBurn',
        'recvWindow' => 'int',
    ];
