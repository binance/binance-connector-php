...
/**
 * GetUserCommissionRateForUmResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class GetUserCommissionRateForUmResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getUserCommissionRateForUmResponse';
     ...
     *
     * @param null|string $makerCommissionRate 0.02%
     *
     * @return self
     */
     ...
     *
     * @param null|string $takerCommissionRate 0.04%
     *
     * @return self
     */
