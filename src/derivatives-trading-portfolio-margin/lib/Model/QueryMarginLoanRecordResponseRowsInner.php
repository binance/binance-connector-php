...
/**
 * QueryMarginLoanRecordResponseRowsInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class QueryMarginLoanRecordResponseRowsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'queryMarginLoanRecordResponse_rows_inner';
     ...
     * Sets status.
     *
     * @param null|string $status one of PENDING (pending execution), CONFIRMED (successfully loaned), FAILED (execution failed, nothing happened to your account);
     *
     * @return self
     */
