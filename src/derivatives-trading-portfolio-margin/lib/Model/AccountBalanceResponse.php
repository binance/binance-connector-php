...
class AccountBalanceResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    private $accountBalanceResponse1;

    private $accountBalanceResponse2;
     ...
     *
     * @return null|AccountBalanceResponse1|AccountBalanceResponse2
     */
    public function getInstance()
    {
        $instance = $this->getAccountBalanceResponse1();
        if (!empty($instance)) {
            return $instance;
        }
        $instance = $this->getAccountBalanceResponse2();
        if (!empty($instance)) {
            return $instance;
        }
    ...
    public function getAccountBalanceResponse1(): ?AccountBalanceResponse1
    {
        return $this->accountBalanceResponse1;
    }

    public function setAccountBalanceResponse1(AccountBalanceResponse1 $accountBalanceResponse1): void
    {
        $this->accountBalanceResponse1 = $accountBalanceResponse1;
    }

    public function getAccountBalanceResponse2(): ?AccountBalanceResponse2
    {
        return $this->accountBalanceResponse2;
    }

    public function setAccountBalanceResponse2(AccountBalanceResponse2 $accountBalanceResponse2): void
    {
        $this->accountBalanceResponse2 = $accountBalanceResponse2;
    }
    ...
    {
        return [
            '\Binance\Client\DerivativesTradingPortfolioMargin\Model\AccountBalanceResponse1' => 'setAccountBalanceResponse1',
            '\Binance\Client\DerivativesTradingPortfolioMargin\Model\AccountBalanceResponse2' => 'setAccountBalanceResponse2',
        ];
    }
     ...
     * Sets asset.
     *
     * @param null|string $asset asset name
     *
     * @return self
     */
     ...
     *
     * @param null|string $negativeBalance negative balance amount
     *
     * @return self
     */
