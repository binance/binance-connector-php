...
/**
 * GetUmAccountDetailResponsePositionsInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class GetUmAccountDetailResponsePositionsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getUmAccountDetailResponse_positions_inner';
     ...
     * Sets initialMargin.
     *
     * @param null|string $initialMargin total initial margin required with current mark price
     *
     * @return self
     */
     ...
     * Sets maxNotional.
     *
     * @param null|string $maxNotional maximum available notional with current leverage
     *
     * @return self
     */
     ...
     * Sets bidNotional.
     *
     * @param null|string $bidNotional bids notional, ignore
     *
     * @return self
     */
     ...
     * Sets askNotional.
     *
     * @param null|string $askNotional ask notional, ignore
     *
     * @return self
     */
