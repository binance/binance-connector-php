...
/**
 * NewUmOrderRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class NewUmOrderRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'newUmOrderRequest';
     ...
     * Sets quantity.
     *
     * @param null|float $quantity Place amount
     *
     * @return self
     */
     ...
     *
     * @param null|string $newClientOrderId A unique id among open orders. Automatically generated if not sent. Can only be string following the rule: `^[\\.A-Z\\:/a-z0-9_-]{1,32}$`
     *
     * @return self
     */
