...
/**
 * MarginMaxBorrowResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class MarginMaxBorrowResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'marginMaxBorrowResponse';
     ...
     * Sets amount.
     *
     * @param null|string $amount account's currently max borrowable amount with sufficient system availability
     *
     * @return self
     */
     ...
     * Sets borrowLimit.
     *
     * @param null|string $borrowLimit max borrowable amount limited by the account level
     *
     * @return self
     */
