...
/**
 * NewCmConditionalOrderRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class NewCmConditionalOrderRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'newCmConditionalOrderRequest';
     ...
     * Sets reduceOnly.
     *
     * @param null|string $reduceOnly \"true\" or \"false\". default \"false\". Cannot be sent in Hedge Mode
     *
     * @return self
     */
     ...
     *
     * @param null|string $newClientStrategyId A unique id among open orders. Automatically generated if not sent. Can only be string following the rule: `^[\\.A-Z\\:/a-z0-9_-]{1,36}$`
     *
     * @return self
     */
    ...
    public function setCallbackRate($callbackRate)
    {
        ...
        if ($callbackRate > 5) {
            throw new \InvalidArgumentException('invalid value for $callbackRate when calling NewCmConditionalOrderRequest., must be smaller than or equal to 5.');
        }
        if ($callbackRate < 0.1) {
            throw new \InvalidArgumentException('invalid value for $callbackRate when calling NewCmConditionalOrderRequest., must be bigger than or equal to 0.1.');
        }
