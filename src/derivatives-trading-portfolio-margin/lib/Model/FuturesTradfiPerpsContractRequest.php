...
/**
 * FuturesTradfiPerpsContractRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class FuturesTradfiPerpsContractRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'futuresTradfiPerpsContractRequest';
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling FuturesTradfiPerpsContractRequest., must be smaller than or equal to 60000.');
        }
