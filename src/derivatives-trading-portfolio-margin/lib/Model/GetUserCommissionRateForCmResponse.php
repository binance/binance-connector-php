...
/**
 * GetUserCommissionRateForCmResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class GetUserCommissionRateForCmResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getUserCommissionRateForCmResponse';
    ...
    /**
     * Gets makerCommissionRate.
     *
     * @return null|string
     */
    public function getMakerCommissionRate()
    {
        return $this->container['makerCommissionRate'];
    }

    /**
     * Sets makerCommissionRate.
     *
     * @param null|string $makerCommissionRate 0.015%
     *
     * @return self
     */
    public function setMakerCommissionRate($makerCommissionRate)
    {
        if (is_null($makerCommissionRate)) {
            throw new \InvalidArgumentException('non-nullable makerCommissionRate cannot be null');
        }
        $this->container['makerCommissionRate'] = $makerCommissionRate;
     ...
     *
     * @param null|string $takerCommissionRate 0.040%
     *
     * @return self
     */
