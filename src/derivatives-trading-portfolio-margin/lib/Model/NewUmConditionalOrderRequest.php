...
/**
 * NewUmConditionalOrderRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class NewUmConditionalOrderRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'newUmConditionalOrderRequest';
    ...
    protected static $openAPITypes = [
        ...
        'positionSide' => '\Binance\Client\DerivativesTradingPortfolioMargin\Model\PositionSide',
        'strategyType' => '\Binance\Client\DerivativesTradingPortfolioMargin\Model\StrategyType',
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['strategyType']) {
            $invalidProperties[] = "'strategyType' can't be null";
        }
        if (!is_null($this->container['callbackRate']) && ($this->container['callbackRate'] > 5)) {
            $invalidProperties[] = "invalid value for 'callbackRate', must be smaller than or equal to 5.";
        }
     ...
     * Sets priceProtect.
     *
     * @param null|PriceProtect $priceProtect priceProtect
     *
     * @return self
     */
     ...
     *
     * @param null|string $newClientStrategyId A unique id among open orders. Automatically generated if not sent. Can only be string following the rule: `^[\\.A-Z\\:/a-z0-9_-]{1,32}$`
     *
     * @return self
     */
     ...
     *
     * @param null|float $activationPrice used with `TRAILING_STOP_MARKET` orders
     *
     * @return self
     */
     ...
     * Sets callbackRate.
     *
     * @param null|float $callbackRate used with `TRAILING_STOP_MARKET` orders
     *
     * @return self
     */
    public function setCallbackRate($callbackRate)
    {
        ...
        if ($callbackRate > 5) {
            throw new \InvalidArgumentException('invalid value for $callbackRate when calling NewUmConditionalOrderRequest., must be smaller than or equal to 5.');
        }
        if ($callbackRate < 0.1) {
            throw new \InvalidArgumentException('invalid value for $callbackRate when calling NewUmConditionalOrderRequest., must be bigger than or equal to 0.1.');
        }
     ...
     * Sets goodTillDate.
     *
     * @param null|int $goodTillDate order cancel time for timeInForce `GTD`, mandatory when `timeInforce` set to `GTD`; order the timestamp only retains second-level precision, ms part will be ignored; The goodTillDate timestamp must be greater than the current time plus 600 seconds and smaller than 253402300799000Mode. It must be sent in Hedge Mode.
     *
     * @return self
     */
