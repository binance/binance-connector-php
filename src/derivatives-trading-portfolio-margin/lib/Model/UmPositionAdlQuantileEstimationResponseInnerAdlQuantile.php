...
/**
 * UmPositionAdlQuantileEstimationResponseInnerAdlQuantile Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class UmPositionAdlQuantileEstimationResponseInnerAdlQuantile implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'umPositionAdlQuantileEstimationResponse_inner_adlQuantile';
     ...
     * Sets sHORT.
     *
     * @param null|int $sHORT adl quantile for \"SHORT\" position in hedge mode
     *
     * @return self
     */
     ...
     * Sets bOTH.
     *
     * @param null|int $bOTH adl quantile for position in one-way mode
     *
     * @return self
     */
