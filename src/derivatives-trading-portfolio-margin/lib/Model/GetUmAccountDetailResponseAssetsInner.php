...
/**
 * GetUmAccountDetailResponseAssetsInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class GetUmAccountDetailResponseAssetsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getUmAccountDetailResponse_assets_inner';
     ...
     *
     * @param null|string $crossWalletBalance wallet balance
     *
     * @return self
     */
     ...
     * Sets crossUnPnl.
     *
     * @param null|string $crossUnPnl unrealized profit
     *
     * @return self
     */
