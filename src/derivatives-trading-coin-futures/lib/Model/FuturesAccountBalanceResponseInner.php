...
class FuturesAccountBalanceResponseInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets accountAlias.
     *
     * @param null|string $accountAlias unique account code
     *
     * @return self
     */
     ...
     * Sets balance.
     *
     * @param null|string $balance account balance
     *
     * @return self
     */
     ...
     *
     * @param null|string $withdrawAvailable available amount for withdrawal
     *
     * @return self
     */
