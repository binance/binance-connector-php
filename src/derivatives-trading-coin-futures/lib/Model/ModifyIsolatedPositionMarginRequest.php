...
/**
 * ModifyIsolatedPositionMarginRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class ModifyIsolatedPositionMarginRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'modifyIsolatedPositionMarginRequest';
     ...
     * Sets amount.
     *
     * @param float $amount Margin asset
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling ModifyIsolatedPositionMarginRequest., must be smaller than or equal to 60000.');
        }
