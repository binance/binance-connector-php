...
/**
 * ExchangeInformationResponseRateLimitsInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class ExchangeInformationResponseRateLimitsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'exchangeInformationResponse_rateLimits_inner';
     ...
     * Sets interval.
     *
     * @param null|string $interval rate limit interval
     *
     * @return self
     */
     ...
     * Sets intervalNum.
     *
     * @param null|int $intervalNum rate limit interval multiplier
     *
     * @return self
     */
     ...
     * Sets rateLimitType.
     *
     * @param null|string $rateLimitType rate limit type
     *
     * @return self
     */
