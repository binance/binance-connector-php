...
/**
 * CurrentAllOpenOrdersResponseInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class CurrentAllOpenOrdersResponseInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'currentAllOpenOrdersResponse_inner';
     ...
     * Sets avgPrice.
     *
     * @param null|string $avgPrice Average execution price
     *
     * @return self
     */
     ...
     * Sets cumBase.
     *
     * @param null|string $cumBase cumulative base asset amount
     *
     * @return self
     */
