...
class NewOrderRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'type' => '\Binance\Client\DerivativesTradingCoinFutures\Model\OrderType',
        'reduceOnly' => '\Binance\Client\DerivativesTradingCoinFutures\Model\ReduceOnly',
        'quantity' => 'float',
        'price' => 'float',
        ...
        'priceProtect' => '\Binance\Client\DerivativesTradingCoinFutures\Model\PriceProtect',
     ...
     * Sets quantity.
     *
     * @param null|float $quantity quantity measured by contract number, Cannot be sent with `closePosition`=`true`
     *
     * @return self
     */
     ...
     * Sets closePosition.
     *
     * @param null|string $closePosition `true`, `false`；Close-All,used with `STOP_MARKET` or `TAKE_PROFIT_MARKET`
     *
     * @return self
     */
     ...
     * Sets callbackRate.
     *
     * @param null|float $callbackRate Used with `TRAILING_STOP_MARKET` orders, min 0.1, max 10 where 1 for 1%
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling NewOrderRequest., must be smaller than or equal to 60000.');
        }
