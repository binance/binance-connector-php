...
class ModifyOrderRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param null|string $origClientOrderId Client order ID
     *
     * @return self
     */
     ...
     * Sets quantity.
     *
     * @param null|float $quantity Order quantity, cannot be sent with `closePosition=true`. **After CM migration, this parameter becomes mandatory** (must be sent together with `price`).
     *
     * @return self
     */
     ...
     * Sets price.
     *
     * @param null|float $price Order price. **After CM migration, this parameter becomes mandatory** (must be sent together with `quantity`).
     *
     * @return self
     */
     ...
     * Sets modifyId.
     *
     * @param null|int $modifyId User-defined modification identifier, returned as-is in the response. Optional; not validated for uniqueness.
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling ModifyOrderRequest., must be smaller than or equal to 60000.');
        }
