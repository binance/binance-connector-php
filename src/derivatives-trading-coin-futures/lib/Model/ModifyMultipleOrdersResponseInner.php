...
/**
 * ModifyMultipleOrdersResponseInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class ModifyMultipleOrdersResponseInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'modifyMultipleOrdersResponse_inner';
    ...
    {
        return $this->container['modifyId'];
    }

    /**
     * Sets modifyId.
     *
     * @param null|int $modifyId user-defined modification identifier, only returned if provided in the request
     *
     * @return self
     */
    public function setModifyId($modifyId)
    {
        if (is_null($modifyId)) {
