...
class Ticker24hrPriceChangeStatisticsResponseInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('baseVolume', $data ?? [], null);
     ...
     * Sets symbol.
     *
     * @param null|string $symbol Trading symbol
     *
     * @return self
     */
    ...
    {
        return $this->container['baseVolume'];
    }

    /**
     * Sets baseVolume.
     *
     * @param null|string $baseVolume base asset volume
     *
     * @return self
     */
    public function setBaseVolume($baseVolume)
    {
        if (is_null($baseVolume)) {
            throw new \InvalidArgumentException('non-nullable baseVolume cannot be null');
        }
        $this->container['baseVolume'] = $baseVolume;
