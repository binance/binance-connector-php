...
/**
 * ModifyMultipleOrdersRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class ModifyMultipleOrdersRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'modifyMultipleOrdersRequest';
    ...
    protected static $openAPITypes = [
        'batchOrders' => '\Binance\Client\DerivativesTradingCoinFutures\Model\BatchOrders',
        'recvWindow' => 'int',
    ];
     ...
     * Sets batchOrders.
     *
     * @param BatchOrders $batchOrders batchOrders
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling ModifyMultipleOrdersRequest., must be smaller than or equal to 60000.');
        }
