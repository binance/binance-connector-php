...
/**
 * SymbolOrderBookTickerResponseInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class SymbolOrderBookTickerResponseInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'symbolOrderBookTickerResponse_inner';
     ...
     * Sets lastUpdateId.
     *
     * @param null|int $lastUpdateId last update ID
     *
     * @return self
     */
     ...
     * Sets bidQty.
     *
     * @param null|string $bidQty best bid quantity
     *
     * @return self
     */
     ...
     * Sets askQty.
     *
     * @param null|string $askQty best ask quantity
     *
     * @return self
     */
