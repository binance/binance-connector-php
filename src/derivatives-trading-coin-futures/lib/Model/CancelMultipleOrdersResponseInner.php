...
/**
 * CancelMultipleOrdersResponseInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class CancelMultipleOrdersResponseInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'cancelMultipleOrdersResponse_inner';
     ...
     * Sets cumQty.
     *
     * @param null|string $cumQty cumulative filled quantity
     *
     * @return self
     */
     ...
     * Sets executedQty.
     *
     * @param null|string $executedQty Executed quantity
     *
     * @return self
     */
     ...
     * Sets orderId.
     *
     * @param null|int $orderId Sub-order ID
     *
     * @return self
     */
     ...
     * Sets origQty.
     *
     * @param null|string $origQty Original order quantity
     *
     * @return self
     */
     ...
     * Sets reduceOnly.
     *
     * @param null|bool $reduceOnly whether the order is reduce-only
     *
     * @return self
     */
     ...
     * Sets side.
     *
     * @param null|string $side Trading side
     *
     * @return self
     */
     ...
     * Sets closePosition.
     *
     * @param null|bool $closePosition if Close-All
     *
     * @return self
     */
     ...
     * Sets origType.
     *
     * @param null|string $origType original order type
     *
     * @return self
     */
     ...
     * Sets type.
     *
     * @param null|string $type order type
     *
     * @return self
     */
     ...
     * Sets workingType.
     *
     * @param null|string $workingType stop trigger price type
     *
     * @return self
     */
     ...
     * Sets priceProtect.
     *
     * @param null|bool $priceProtect if conditional order trigger is protected
     *
     * @return self
     */
     ...
     * Sets priceMatch.
     *
     * @param null|string $priceMatch price match mode
     *
     * @return self
     */
     ...
     * Sets code.
     *
     * @param null|int $code API response code. \"000000\" indicates success.
     *
     * @return self
     */
     ...
     * Sets msg.
     *
     * @param null|string $msg message details
     *
     * @return self
     */
