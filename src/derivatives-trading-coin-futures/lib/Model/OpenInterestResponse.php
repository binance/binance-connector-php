...
/**
 * OpenInterestResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class OpenInterestResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'openInterestResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('openInterest', $data ?? [], null);
    ...
    {
        return $this->container['openInterest'];
    }

    /**
     * Sets openInterest.
     *
     * @param null|string $openInterest open interest
     *
     * @return self
     */
    public function setOpenInterest($openInterest)
    {
        if (is_null($openInterest)) {
            throw new \InvalidArgumentException('non-nullable openInterest cannot be null');
        }
        $this->container['openInterest'] = $openInterest;
