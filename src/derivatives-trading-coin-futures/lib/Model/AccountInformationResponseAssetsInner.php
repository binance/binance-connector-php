...
/**
 * AccountInformationResponseAssetsInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class AccountInformationResponseAssetsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'accountInformationResponse_assets_inner';
     ...
     * Sets walletBalance.
     *
     * @param null|string $walletBalance total wallet balance
     *
     * @return self
     */
     ...
     * Sets marginBalance.
     *
     * @param null|string $marginBalance margin balance
     *
     * @return self
     */
     ...
     *
     * @param null|string $maxWithdrawAmount maximum amount for transfer out
     *
     * @return self
     */
     ...
     *
     * @param null|string $crossWalletBalance wallet balance for crossed margin
     *
     * @return self
     */
     ...
     * Sets crossUnPnl.
     *
     * @param null|string $crossUnPnl total unrealized profit or loss of crossed positions
     *
     * @return self
     */
     ...
     *
     * @param null|string $availableBalance available margin balance
     *
     * @return self
     */
