...
class ExchangeInformationResponseSymbolsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets filters.
     *
     * @param null|ExchangeInformationResponseSymbolsInnerFiltersInner[] $filters trading filters and constraints
     *
     * @return self
     */
     ...
     * Sets orderTypes.
     *
     * @param null|string[] $orderTypes supported order types
     *
     * @return self
     */
     ...
     * Sets liquidationFee.
     *
     * @param null|string $liquidationFee liquidation fee rate
     *
     * @return self
     */
     ...
     *
     * @param null|string $marketTakeBound the max price difference rate( from mark price) a market order can make
     *
     * @return self
     */
     ...
     * Sets deliveryDate.
     *
     * @param null|int $deliveryDate delivery timestamp
     *
     * @return self
     */
     ...
     * Sets onboardDate.
     *
     * @param null|int $onboardDate onboard timestamp
     *
     * @return self
     */
     ...
     * Sets contractStatus.
     *
     * @param null|string $contractStatus contract status
     *
     * @return self
     */
     ...
     * Sets contractSize.
     *
     * @param null|int $contractSize contract size
     *
     * @return self
     */
     ...
     * Sets quoteAsset.
     *
     * @param null|string $quoteAsset quote asset symbol
     *
     * @return self
     */
     ...
     * Sets baseAsset.
     *
     * @param null|string $baseAsset base asset symbol
     *
     * @return self
     */
     ...
     * Sets pricePrecision.
     *
     * @param null|int $pricePrecision please do not use it as tickSize
     *
     * @return self
     */
     ...
     *
     * @param null|int $quantityPrecision please do not use it as stepSize
     *
     * @return self
     */
     ...
     *
     * @param null|int $baseAssetPrecision base asset precision
     *
     * @return self
     */
     ...
     * Sets quotePrecision.
     *
     * @param null|int $quotePrecision quote asset precision
     *
     * @return self
     */
     ...
     *
     * @param null|int $equalQtyPrecision ignore
     *
     * @return self
     */
     ...
     * Sets triggerProtect.
     *
     * @param null|string $triggerProtect threshold for algo order with \"priceProtect\"
     *
     * @return self
     */
     ...
     *
     * @param null|string $maintMarginPercent ignore
     *
     * @return self
     */
     ...
     *
     * @param null|string $requiredMarginPercent ignore
     *
     * @return self
     */
     ...
     * Sets underlyingType.
     *
     * @param null|string $underlyingType underlying asset type
     *
     * @return self
     */
     ...
     *
     * @param null|string[] $underlyingSubType underlying asset sub-type
     *
     * @return self
     */
