...
class DefaultApi
{
    ...
    public function __construct(
        ...
        $this->userAgent = CommonUtils::getUserAgent('pay');
    }
    ...
    public function getPayTradeHistoryRequest($startTime = null, $endTime = null, $limit = null, $recvWindow = null)
    {
        ...
        if (null !== $limit && $limit > 100) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling DefaultApi.getPayTradeHistory, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling DefaultApi.getPayTradeHistory, must be smaller than or equal to 60000.');
        }
