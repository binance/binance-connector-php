...
class GetPayTradeHistoryResponseDataInnerPayerInfo implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets name.
     *
     * @param null|string $name nickname or merchant name
     *
     * @return self
     */
     ...
     * Sets type.
     *
     * @param null|string $type account type: USER for personal, MERCHANT for merchant
     *
     * @return self
     */
     ...
     * Sets binanceId.
     *
     * @param null|string $binanceId binance UID
     *
     * @return self
     */
