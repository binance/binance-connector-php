...
class GetPayTradeHistoryResponseDataInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets orderType.
     *
     * @param null|string $orderType Order type. Enum: PAY, PAY_REFUND, C2C, CRYPTO_BOX, CRYPTO_BOX_RF, C2C_HOLDING, C2C_HOLDING_RF, PAYOUT, REMITTANCE.
     *
     * @return self
     */
     ...
     *
     * @param null|int $transactionTime trade timestamp
     *
     * @return self
     */
     ...
     * Sets amount.
     *
     * @param null|string $amount Order amount (up to 8 decimal places). Positive means income; negative means expenditure.
     *
     * @return self
     */
     ...
     * Sets currency.
     *
     * @param null|string $currency order asset
     *
     * @return self
     */
     ...
     * Sets walletType.
     *
     * @param null|int $walletType main wallet type: 1=funding wallet, 2=spot wallet, 3=fiat wallet, 4 or 6=card payment, 5=earn wallet
     *
     * @return self
     */
     ...
     * Sets walletTypes.
     *
     * @param null|int[] $walletTypes Array format of wallet types. Multiple values may appear for combined payments.
     *
     * @return self
     */
     ...
     * Sets fundsDetail.
     *
     * @param null|GetPayTradeHistoryResponseDataInnerFundsDetailInner[] $fundsDetail funds usage details
     *
     * @return self
     */
