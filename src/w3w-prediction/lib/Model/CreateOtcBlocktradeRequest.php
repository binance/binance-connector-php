...
/**
 * CreateOtcBlocktradeRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class CreateOtcBlocktradeRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createOtcBlocktradeRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('pricePerShare', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['marketId']) {
            $invalidProperties[] = "'marketId' can't be null";
        }
        ...
        if (null === $this->container['makerAmount']) {
            $invalidProperties[] = "'makerAmount' can't be null";
        }
        if (null === $this->container['takerAmount']) {
            $invalidProperties[] = "'takerAmount' can't be null";
        }
        if (null === $this->container['pricePerShare']) {
            $invalidProperties[] = "'pricePerShare' can't be null";
        }
    ...
    {
        return $this->container['pricePerShare'];
    }
    ...
    {
        if (is_null($pricePerShare)) {
            throw new \InvalidArgumentException('non-nullable pricePerShare cannot be null');
        }
        $this->container['pricePerShare'] = $pricePerShare;
     ...
     * Sets expiration.
     *
     * @param int $expiration Expiration timestamp in seconds (GTD order)
     *
     * @return self
     */
