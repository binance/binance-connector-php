# Migration Guide: Binance VIP Connector Modularization
...
```php
use \Binance\Client\VipLoan\Api\W3WPredictionRestApi;
```

4. **Configuration and Client Initialization**:  
   The new structure keeps the existing configuration options but modularized clients into `W3WPredictionRestApi`.
