...
/**
 * SubscribeEthStakingRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class SubscribeEthStakingRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'subscribeEthStakingRequest';
     ...
     * Sets amount.
     *
     * @param float $amount Amount in ETH, limit 4 decimals
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling SubscribeEthStakingRequest., must be smaller than or equal to 60000.');
        }
