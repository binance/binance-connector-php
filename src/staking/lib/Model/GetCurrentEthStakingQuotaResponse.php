...
class GetCurrentEthStakingQuotaResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param null|string $leftStakingPersonalQuota Show min (Daily available limit, total personal staking quota)
     *
     * @return self
     */
     ...
     *
     * @param null|string $leftRedemptionPersonalQuota Show min (Daily personal redeem quota, total redemption limit)
     *
     * @return self
     */
