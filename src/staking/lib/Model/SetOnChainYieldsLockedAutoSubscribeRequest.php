...
/**
 * SetOnChainYieldsLockedAutoSubscribeRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class SetOnChainYieldsLockedAutoSubscribeRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'setOnChainYieldsLockedAutoSubscribeRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['autoSubscribe']) {
            $invalidProperties[] = "'autoSubscribe' can't be null";
        }
     ...
     * Sets autoSubscribe.
     *
     * @param bool $autoSubscribe autoSubscribe
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling SetOnChainYieldsLockedAutoSubscribeRequest., must be smaller than or equal to 60000.');
        }
