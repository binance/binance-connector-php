...
/**
 * SubscribeOnChainYieldsLockedProductRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class SubscribeOnChainYieldsLockedProductRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'subscribeOnChainYieldsLockedProductRequest';
    ...
    protected static $openAPITypes = [
        ...
        'amount' => 'float',
        'autoSubscribe' => 'bool',
        'sourceAccount' => '\Binance\Client\Staking\Model\SourceAccount',
        'redeemTo' => '\Binance\Client\Staking\Model\RedeemTo',
        'channelId' => 'string',
        'clientId' => 'string',
        'recvWindow' => 'int',
    ];
     ...
     * Sets sourceAccount.
     *
     * @param null|SourceAccount $sourceAccount sourceAccount
     *
     * @return self
     */
     ...
     * Sets redeemTo.
     *
     * @param null|RedeemTo $redeemTo redeemTo
     *
     * @return self
     */
     ...
     * Sets channelId.
     *
     * @param null|string $channelId channelId
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling SubscribeOnChainYieldsLockedProductRequest., must be smaller than or equal to 60000.');
        }
