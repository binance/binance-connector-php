...
/**
 * GetSoftStakingProductListResponseRowsInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class GetSoftStakingProductListResponseRowsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getSoftStakingProductListResponse_rows_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('maxCap', $data ?? [], null);
        $this->setIfExists('apr', $data ?? [], null);
        $this->setIfExists('stakedAmount', $data ?? [], null);
     ...
     * Sets maxCap.
     *
     * @param null|string $maxCap maxCap
     *
     * @return self
     */
    ...
    {
        if (is_null($maxCap)) {
            throw new \InvalidArgumentException('non-nullable maxCap cannot be null');
        }
     ...
     * @return null|string
     */
    public function getStakedAmount()
    {
        return $this->container['stakedAmount'];
    }

    /**
     * Sets stakedAmount.
     *
     * @param null|string $stakedAmount stakedAmount
     *
     * @return self
     */
    public function setStakedAmount($stakedAmount)
    {
        if (is_null($stakedAmount)) {
            throw new \InvalidArgumentException('non-nullable stakedAmount cannot be null');
        }
        $this->container['stakedAmount'] = $stakedAmount;
