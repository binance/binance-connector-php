...
/**
 * RedeemSolRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class RedeemSolRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'redeemSolRequest';
     ...
     * Sets amount.
     *
     * @param float $amount Amount in BNSOL, limit 8 decimals
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling RedeemSolRequest., must be smaller than or equal to 60000.');
        }
