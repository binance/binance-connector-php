...
/**
 * RedeemOnChainYieldsLockedProductRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class RedeemOnChainYieldsLockedProductRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'redeemOnChainYieldsLockedProductRequest';
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling RedeemOnChainYieldsLockedProductRequest., must be smaller than or equal to 60000.');
        }
