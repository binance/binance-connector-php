...
/**
 * WrapBethRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class WrapBethRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'wrapBethRequest';
     ...
     * Sets amount.
     *
     * @param float $amount Amount in BETH, limit 4 decimals
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling WrapBethRequest., must be smaller than or equal to 60000.');
        }
