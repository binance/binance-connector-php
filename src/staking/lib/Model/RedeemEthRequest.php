...
/**
 * RedeemEthRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class RedeemEthRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'redeemEthRequest';
    ...
    protected static $openAPITypes = [
        'amount' => 'float',
        'asset' => '\Binance\Client\Staking\Model\Asset',
        'recvWindow' => 'int',
    ];
     ...
     * Sets amount.
     *
     * @param float $amount Amount in BETH, limit 8 decimals
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling RedeemEthRequest., must be smaller than or equal to 60000.');
        }
