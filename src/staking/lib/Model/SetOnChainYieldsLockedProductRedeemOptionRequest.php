...
/**
 * SetOnChainYieldsLockedProductRedeemOptionRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class SetOnChainYieldsLockedProductRedeemOptionRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'setOnChainYieldsLockedProductRedeemOptionRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['positionId']) {
            $invalidProperties[] = "'positionId' can't be null";
        }
        if (null === $this->container['redeemTo']) {
            $invalidProperties[] = "'redeemTo' can't be null";
        }
     ...
     * Sets redeemTo.
     *
     * @param RedeemTo $redeemTo redeemTo
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling SetOnChainYieldsLockedProductRedeemOptionRequest., must be smaller than or equal to 60000.');
        }
