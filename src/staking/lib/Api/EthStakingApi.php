...
class EthStakingApi
{
    ...
    public function ethStakingAccountRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling EthStakingApi.ethStakingAccount, must be smaller than or equal to 60000.');
        }
    ...
    public function getCurrentEthStakingQuotaRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling EthStakingApi.getCurrentEthStakingQuota, must be smaller than or equal to 60000.');
        }
    ...
    public function getEthRedemptionHistoryRequest($redeemId = null, $startTime = null, $endTime = null, $current = null, $size = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling EthStakingApi.getEthRedemptionHistory, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling EthStakingApi.getEthRedemptionHistory, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling EthStakingApi.getEthRedemptionHistory, must be smaller than or equal to 60000.');
        }
    ...
    public function getEthStakingHistoryRequest($purchaseId = null, $startTime = null, $endTime = null, $current = null, $size = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling EthStakingApi.getEthStakingHistory, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling EthStakingApi.getEthStakingHistory, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling EthStakingApi.getEthStakingHistory, must be smaller than or equal to 60000.');
        }
    ...
    public function getWbethRateHistoryRequest($startTime = null, $endTime = null, $current = null, $size = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling EthStakingApi.getWbethRateHistory, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling EthStakingApi.getWbethRateHistory, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling EthStakingApi.getWbethRateHistory, must be smaller than or equal to 60000.');
        }
    ...
    public function getWbethRewardsHistoryRequest($startTime = null, $endTime = null, $current = null, $size = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling EthStakingApi.getWbethRewardsHistory, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling EthStakingApi.getWbethRewardsHistory, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling EthStakingApi.getWbethRewardsHistory, must be smaller than or equal to 60000.');
        }
    ...
    public function getWbethUnwrapHistoryRequest($startTime = null, $endTime = null, $current = null, $size = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling EthStakingApi.getWbethUnwrapHistory, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling EthStakingApi.getWbethUnwrapHistory, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling EthStakingApi.getWbethUnwrapHistory, must be smaller than or equal to 60000.');
        }
    ...
    public function getWbethWrapHistoryRequest($startTime = null, $endTime = null, $current = null, $size = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling EthStakingApi.getWbethWrapHistory, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling EthStakingApi.getWbethWrapHistory, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling EthStakingApi.getWbethWrapHistory, must be smaller than or equal to 60000.');
        }
