...
class OnChainYieldsApi
{
    ...
    public function getOnChainYieldsLockedPersonalLeftQuotaRequest($projectId, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling OnChainYieldsApi.getOnChainYieldsLockedPersonalLeftQuota, must be smaller than or equal to 60000.');
        }
    ...
    public function getOnChainYieldsLockedProductListRequest($asset = null, $current = null, $size = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling OnChainYieldsApi.getOnChainYieldsLockedProductList, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling OnChainYieldsApi.getOnChainYieldsLockedProductList, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling OnChainYieldsApi.getOnChainYieldsLockedProductList, must be smaller than or equal to 60000.');
        }
    ...
    public function getOnChainYieldsLockedProductPositionRequest($asset = null, $positionId = null, $projectId = null, $current = null, $size = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling OnChainYieldsApi.getOnChainYieldsLockedProductPosition, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling OnChainYieldsApi.getOnChainYieldsLockedProductPosition, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling OnChainYieldsApi.getOnChainYieldsLockedProductPosition, must be smaller than or equal to 60000.');
        }
    ...
    public function getOnChainYieldsLockedRedemptionRecordRequest($positionId = null, $redeemId = null, $asset = null, $startTime = null, $endTime = null, $current = null, $size = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling OnChainYieldsApi.getOnChainYieldsLockedRedemptionRecord, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling OnChainYieldsApi.getOnChainYieldsLockedRedemptionRecord, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling OnChainYieldsApi.getOnChainYieldsLockedRedemptionRecord, must be smaller than or equal to 60000.');
        }
    ...
    public function getOnChainYieldsLockedRewardsHistoryRequest($positionId = null, $asset = null, $startTime = null, $endTime = null, $current = null, $size = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling OnChainYieldsApi.getOnChainYieldsLockedRewardsHistory, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling OnChainYieldsApi.getOnChainYieldsLockedRewardsHistory, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling OnChainYieldsApi.getOnChainYieldsLockedRewardsHistory, must be smaller than or equal to 60000.');
        }
     ...
     * @param null|bool $autoSubscribe (optional)
     * @param null|int  $recvWindow    Request validity window in milliseconds. (optional)
     *
     * @return ApiResponse<GetOnChainYieldsLockedSubscriptionPreviewResponse>
     *
    ...
    public function getOnChainYieldsLockedSubscriptionPreviewRequest($projectId, $amount, $autoSubscribe = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling OnChainYieldsApi.getOnChainYieldsLockedSubscriptionPreview, must be smaller than or equal to 60000.');
        }
    ...
    public function getOnChainYieldsLockedSubscriptionRecordRequest($purchaseId = null, $clientId = null, $asset = null, $startTime = null, $endTime = null, $current = null, $size = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling OnChainYieldsApi.getOnChainYieldsLockedSubscriptionRecord, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling OnChainYieldsApi.getOnChainYieldsLockedSubscriptionRecord, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling OnChainYieldsApi.getOnChainYieldsLockedSubscriptionRecord, must be smaller than or equal to 60000.');
        }
    ...
    public function onChainYieldsAccountRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling OnChainYieldsApi.onChainYieldsAccount, must be smaller than or equal to 60000.');
        }
