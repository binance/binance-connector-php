...
class SolStakingApi
{
     ...
     * Claim Boost Rewards (TRADE)
     *
     * @param null|ClaimBoostRewardsRequest $claimBoostRewardsRequest (optional)
     *
     * @return ApiResponse<ClaimBoostRewardsResponse>
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function claimBoostRewardsWithHttpInfo($claimBoostRewardsRequest = null): ApiResponse
    {
     ...
     * @throws \InvalidArgumentException
     */
    public function claimBoostRewardsRequest($claimBoostRewardsRequest = null)
    {
    ...
    public function getBnsolRateHistoryRequest($startTime = null, $endTime = null, $current = null, $size = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling SolStakingApi.getBnsolRateHistory, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling SolStakingApi.getBnsolRateHistory, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling SolStakingApi.getBnsolRateHistory, must be smaller than or equal to 60000.');
        }
    ...
    public function getBnsolRewardsHistoryRequest($startTime = null, $endTime = null, $current = null, $size = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling SolStakingApi.getBnsolRewardsHistory, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling SolStakingApi.getBnsolRewardsHistory, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling SolStakingApi.getBnsolRewardsHistory, must be smaller than or equal to 60000.');
        }
    ...
    public function getBoostRewardsHistoryRequest($type, $startTime = null, $endTime = null, $current = null, $size = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling SolStakingApi.getBoostRewardsHistory, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling SolStakingApi.getBoostRewardsHistory, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling SolStakingApi.getBoostRewardsHistory, must be smaller than or equal to 60000.');
        }
    ...
    public function getSolRedemptionHistoryRequest($redeemId = null, $startTime = null, $endTime = null, $current = null, $size = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling SolStakingApi.getSolRedemptionHistory, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling SolStakingApi.getSolRedemptionHistory, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling SolStakingApi.getSolRedemptionHistory, must be smaller than or equal to 60000.');
        }
    ...
    public function getSolStakingHistoryRequest($purchaseId = null, $startTime = null, $endTime = null, $current = null, $size = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling SolStakingApi.getSolStakingHistory, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling SolStakingApi.getSolStakingHistory, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling SolStakingApi.getSolStakingHistory, must be smaller than or equal to 60000.');
        }
    ...
    public function getSolStakingQuotaDetailsRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling SolStakingApi.getSolStakingQuotaDetails, must be smaller than or equal to 60000.');
        }
    ...
    public function getUnclaimedRewardsRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling SolStakingApi.getUnclaimedRewards, must be smaller than or equal to 60000.');
        }
    ...
    public function solStakingAccountRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling SolStakingApi.solStakingAccount, must be smaller than or equal to 60000.');
        }
