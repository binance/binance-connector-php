...
class MarketDataApi
{
    ...
    public const contentTypes = [
        ...
        'assetIndex' => ['application/x-www-form-urlencoded'],
    ...
    {
        return $this->assetIndexWithHttpInfo($symbol);
    }

    /**
     * Operation assetIndexWithHttpInfo.
     *
     * Multi-Assets Mode Asset Index
     *
     * @param null|string $symbol Asset pair (optional)
     ...
     * @throws \InvalidArgumentException
     */
    public function assetIndexWithHttpInfo($symbol = null): ApiResponse
    {
        $request = $this->assetIndexRequest($symbol);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Binance\Client\DerivativesTradingUsdsFutures\Model\AssetIndexResponse',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Create request for operation 'assetIndex'.
     *
     * @param null|string $symbol Asset pair (optional)
     *
     * @return Request
     ...
     * @throws \InvalidArgumentException
     */
    public function assetIndexRequest($symbol = null)
    {
        $contentType = self::contentTypes['assetIndex'][0];
    ...
    public function getFundingRateHistoryRequest($symbol = null, $startTime = null, $endTime = null, $limit = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling MarketDataApi.getFundingRateHistory, must be smaller than or equal to 1000.');
        }
