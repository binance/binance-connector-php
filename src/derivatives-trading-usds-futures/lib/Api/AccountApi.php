...
class AccountApi
{
    ...
    public function accountInformationV2Request($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.accountInformationV2, must be smaller than or equal to 60000.');
        }
    ...
    public function accountInformationV3Request($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.accountInformationV3, must be smaller than or equal to 60000.');
        }
    ...
    public function futuresAccountBalanceV2Request($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.futuresAccountBalanceV2, must be smaller than or equal to 60000.');
        }
    ...
    public function futuresAccountBalanceV3Request($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.futuresAccountBalanceV3, must be smaller than or equal to 60000.');
        }
    ...
    public function futuresAccountConfigurationRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.futuresAccountConfiguration, must be smaller than or equal to 60000.');
        }
    ...
    public function futuresTradingQuantitativeRulesIndicatorsRequest($symbol = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.futuresTradingQuantitativeRulesIndicators, must be smaller than or equal to 60000.');
        }
    ...
    public function getBnbBurnStatusRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.getBnbBurnStatus, must be smaller than or equal to 60000.');
        }
    ...
    public function getCurrentMultiAssetsModeRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.getCurrentMultiAssetsMode, must be smaller than or equal to 60000.');
        }
    ...
    public function notionalAndLeverageBracketsRequest($symbol = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.notionalAndLeverageBrackets, must be smaller than or equal to 60000.');
        }
    ...
    public function queryUserRateLimitRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.queryUserRateLimit, must be smaller than or equal to 60000.');
        }
    ...
    public function symbolConfigurationRequest($symbol = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.symbolConfiguration, must be smaller than or equal to 60000.');
        }
