...
class TradeApi
{
    ...
    public function cancelAlgoOrderRequest($algoId = null, $clientAlgoId = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.cancelAlgoOrder, must be smaller than or equal to 60000.');
        }
    ...
    public function cancelAllAlgoOpenOrdersRequest($symbol, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.cancelAllAlgoOpenOrders, must be smaller than or equal to 60000.');
        }
     ...
     *
     * @param string                     $symbol                (required)
     * @param null|OrderIdList           $orderIdList           (optional)
     * @param null|OrigClientOrderIdList $origClientOrderIdList (optional)
     * @param null|int                   $recvWindow            (optional)
     *
     * @return ApiResponse<CancelMultipleOrdersResponse>
     *
    ...
    public function currentAllAlgoOpenOrdersRequest($algoType = null, $symbol = null, $algoId = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.currentAllAlgoOpenOrders, must be smaller than or equal to 60000.');
        }
    ...
    public function positionInformationV2Request($symbol = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.positionInformationV2, must be smaller than or equal to 60000.');
        }
    ...
    public function positionInformationV3Request($symbol = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.positionInformationV3, must be smaller than or equal to 60000.');
        }
    ...
    public function queryAllAlgoOrdersRequest($symbol, $algoId = null, $startTime = null, $endTime = null, $limit = null, $recvWindow = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling TradeApi.queryAllAlgoOrders, must be smaller than or equal to 1000.');
        }
