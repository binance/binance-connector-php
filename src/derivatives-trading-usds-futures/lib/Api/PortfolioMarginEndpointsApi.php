...
/**
 * PortfolioMarginEndpointsApi Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
...
class PortfolioMarginEndpointsApi
{
    ...
    public const contentTypes = [
        'classicPortfolioMarginAccountInformation' => ['application/x-www-form-urlencoded'],
    ];
    ...
    {
        return $this->classicPortfolioMarginAccountInformationWithHttpInfo($asset, $recvWindow);
    }

    /**
     * Operation classicPortfolioMarginAccountInformationWithHttpInfo.
     *
     * Classic Portfolio Margin Account Information (USER_DATA)
     *
     ...
     * @throws \InvalidArgumentException
     */
    public function classicPortfolioMarginAccountInformationWithHttpInfo($asset, $recvWindow = null): ApiResponse
    {
        $request = $this->classicPortfolioMarginAccountInformationRequest($asset, $recvWindow);
            ...
            switch ($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Binance\Client\DerivativesTradingUsdsFutures\Model\ClassicPortfolioMarginAccountInformationResponse',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Create request for operation 'classicPortfolioMarginAccountInformation'.
     *
     * @param string   $asset      (required)
     * @param null|int $recvWindow (optional)
     *
     ...
     * @throws \InvalidArgumentException
     */
    public function classicPortfolioMarginAccountInformationRequest($asset, $recvWindow = null)
    {
        $contentType = self::contentTypes['classicPortfolioMarginAccountInformation'][0];

        // verify the required parameter 'asset' is set
        if (null === $asset || (is_array($asset) && 0 === count($asset))) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $asset when calling classicPortfolioMarginAccountInformation'
            );
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling PortfolioMarginEndpointsApi.classicPortfolioMarginAccountInformation, must be smaller than or equal to 60000.');
        }

        $resourcePath = '/fapi/v1/pmAccountInfo';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
