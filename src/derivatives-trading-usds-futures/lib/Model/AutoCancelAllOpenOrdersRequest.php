...
/**
 * AutoCancelAllOpenOrdersRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class AutoCancelAllOpenOrdersRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'autoCancelAllOpenOrdersRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('countdownTime', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['countdownTime']) {
            $invalidProperties[] = "'countdownTime' can't be null";
        }
    ...
    {
        return $this->container['countdownTime'];
    }

    /**
     * Sets countdownTime.
     *
     * @param int $countdownTime Countdown in milliseconds. `1000` means 1 second; `0` disables countdown cancel-all.
     *
     * @return self
     */
    public function setCountdownTime($countdownTime)
    {
        if (is_null($countdownTime)) {
            throw new \InvalidArgumentException('non-nullable countdownTime cannot be null');
        }
        $this->container['countdownTime'] = $countdownTime;
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling AutoCancelAllOpenOrdersRequest., must be smaller than or equal to 60000.');
        }
