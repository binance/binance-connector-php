...
class GetPositionMarginChangeHistoryResponseInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('deltaType', $data ?? [], null);
    ...
    {
        return $this->container['deltaType'];
    }

    /**
     * Sets deltaType.
     *
     * @param null|string $deltaType delta Type
     *
     * @return self
     */
    public function setDeltaType($deltaType)
    {
        if (is_null($deltaType)) {
            throw new \InvalidArgumentException('non-nullable deltaType cannot be null');
        }
        $this->container['deltaType'] = $deltaType;
