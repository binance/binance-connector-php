...
class QueryAlgoOrderResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('actualType', $data ?? [], null);
        $this->setIfExists('actualQty', $data ?? [], null);
     ...
     * Sets actualOrderId.
     *
     * @param null|string $actualOrderId empty string if not triggered; orderId if triggered
     *
     * @return self
     */
     ...
     * Sets actualPrice.
     *
     * @param null|string $actualPrice 0 if not triggered; average price if filled/partially filled
     *
     * @return self
     */
    ...
    {
        return $this->container['actualType'];
    }

    /**
     * Sets actualType.
     *
     * @param null|string $actualType optional field, only present when triggered
     *
     * @return self
     */
    public function setActualType($actualType)
    {
        if (is_null($actualType)) {
            throw new \InvalidArgumentException('non-nullable actualType cannot be null');
        }
        $this->container['actualType'] = $actualType;
    ...
    {
        return $this->container['actualQty'];
    }

    /**
     * Sets actualQty.
     *
     * @param null|string $actualQty optional field, only present when filled/partially filled
     *
     * @return self
     */
    public function setActualQty($actualQty)
    {
        if (is_null($actualQty)) {
            throw new \InvalidArgumentException('non-nullable actualQty cannot be null');
        }
        $this->container['actualQty'] = $actualQty;
