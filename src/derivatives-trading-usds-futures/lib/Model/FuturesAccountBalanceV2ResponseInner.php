...
class FuturesAccountBalanceV2ResponseInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets accountAlias.
     *
     * @param null|string $accountAlias unique account alias
     *
     * @return self
     */
     ...
     * Sets balance.
     *
     * @param null|string $balance wallet balance
     *
     * @return self
     */
     ...
     * Sets crossUnPnl.
     *
     * @param null|string $crossUnPnl unrealized PnL of cross positions
     *
     * @return self
     */
