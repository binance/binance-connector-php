...
class ExchangeInformationResponseSymbolsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets deliveryDate.
     *
     * @param null|int $deliveryDate delivery Date
     *
     * @return self
     */
     ...
     * Sets onboardDate.
     *
     * @param null|int $onboardDate onboard Date
     *
     * @return self
     */
     ...
     * Sets baseAsset.
     *
     * @param null|string $baseAsset base Asset
     *
     * @return self
     */
     ...
     * Sets quoteAsset.
     *
     * @param null|string $quoteAsset quote Asset
     *
     * @return self
     */
     ...
     * Sets quotePrecision.
     *
     * @param null|int $quotePrecision quote Precision
     *
     * @return self
     */
     ...
     * @return null|int
     */
    public function getSettlePlan()
    {
        return $this->container['settlePlan'];
    }

    /**
     * Sets settlePlan.
     *
     * @param null|int $settlePlan settlePlan
     *
     * @return self
     */
    public function setSettlePlan($settlePlan)
    {
        if (is_null($settlePlan)) {
            throw new \InvalidArgumentException('non-nullable settlePlan cannot be null');
        }
        $this->container['settlePlan'] = $settlePlan;
