...
class ChangeInitialLeverageRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function setLeverage($leverage)
    {
        ...
        if ($leverage > 125) {
            throw new \InvalidArgumentException('invalid value for $leverage when calling ChangeInitialLeverageRequest., must be smaller than or equal to 125.');
        }
        if ($leverage < 1) {
            throw new \InvalidArgumentException('invalid value for $leverage when calling ChangeInitialLeverageRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling ChangeInitialLeverageRequest., must be smaller than or equal to 60000.');
        }
