...
class BatchOrdersInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public const SELF_TRADE_PREVENTION_MODE_NONE = 'NONE';
    ...
    {
        return [
            self::SELF_TRADE_PREVENTION_MODE_NONE,
     ...
     * Sets positionSide.
     *
     * @param null|string $positionSide default `BOTH` for One-way Mode; `LONG` or `SHORT` for Hedge Mode
     *
     * @return self
     */
     ...
     *
     * @param null|string $selfTradePreventionMode EXPIRE_TAKER: expire taker order when STP triggers/ EXPIRE_MAKER: expire taker order when STP triggers/ EXPIRE_BOTH: expire both orders when STP triggers; default NONE
     *
     * @return self
     */
     ...
     * Sets goodTillDate.
     *
     * @param null|int $goodTillDate auto-cancel time for `GTD` orders
     *
     * @return self
     */
