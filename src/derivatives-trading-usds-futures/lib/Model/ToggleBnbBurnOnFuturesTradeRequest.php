...
/**
 * ToggleBnbBurnOnFuturesTradeRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class ToggleBnbBurnOnFuturesTradeRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'toggleBnbBurnOnFuturesTradeRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['feeBurn']) {
            $invalidProperties[] = "'feeBurn' can't be null";
        }
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling ToggleBnbBurnOnFuturesTradeRequest., must be smaller than or equal to 60000.');
        }
