...
class PositionInformationV3ResponseInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets positionAmt.
     *
     * @param null|string $positionAmt position amount, positive for long, negative for short
     *
     * @return self
     */
     ...
     * Sets markPrice.
     *
     * @param null|string $markPrice current mark price
     *
     * @return self
     */
     ...
     *
     * @param null|string $unRealizedProfit unrealized profit
     *
     * @return self
     */
     ...
     * Sets notional.
     *
     * @param null|string $notional notional value of position
     *
     * @return self
     */
     ...
     * Sets isolatedWallet.
     *
     * @param null|string $isolatedWallet isolated wallet (if isolated position)
     *
     * @return self
     */
     ...
     * Sets initialMargin.
     *
     * @param null|string $initialMargin initial margin required with current mark price
     *
     * @return self
     */
     ...
     * Sets maintMargin.
     *
     * @param null|string $maintMargin maintenance margin required
     *
     * @return self
     */
     ...
     *
     * @param null|string $positionInitialMargin initial margin required for positions with current mark price
     *
     * @return self
     */
     ...
     *
     * @param null|string $openOrderInitialMargin initial margin required for open orders with current mark price
     *
     * @return self
     */
     ...
     * Sets adl.
     *
     * @param null|int $adl auto-deleverage ranking
     *
     * @return self
     */
     ...
     * Sets bidNotional.
     *
     * @param null|string $bidNotional ignore
     *
     * @return self
     */
     ...
     * Sets askNotional.
     *
     * @param null|string $askNotional ignore
     *
     * @return self
     */
