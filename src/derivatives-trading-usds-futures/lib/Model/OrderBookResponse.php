...
class OrderBookResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'e' => 'int',
        't' => 'int',
        'bids' => '\Binance\Client\DerivativesTradingUsdsFutures\Model\OrderBookResponseBidsItem[]',
        'asks' => '\Binance\Client\DerivativesTradingUsdsFutures\Model\OrderBookResponseAsksItem[]',
    ];
