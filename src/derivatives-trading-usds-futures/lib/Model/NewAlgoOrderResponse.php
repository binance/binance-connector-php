...
/**
 * NewAlgoOrderResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class NewAlgoOrderResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'newAlgoOrderResponse';
     ...
     * Sets activatePrice.
     *
     * @param null|string $activatePrice TRAILING_STOP_MARKET order
     *
     * @return self
     */
     ...
     * Sets callbackRate.
     *
     * @param null|string $callbackRate TRAILING_STOP_MARKET order
     *
     * @return self
     */
