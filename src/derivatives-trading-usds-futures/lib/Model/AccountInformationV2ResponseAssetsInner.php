...
/**
 * AccountInformationV2ResponseAssetsInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class AccountInformationV2ResponseAssetsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'accountInformationV2Response_assets_inner';
     ...
     * Sets walletBalance.
     *
     * @param null|string $walletBalance wallet balance
     *
     * @return self
     */
     ...
     * Sets initialMargin.
     *
     * @param null|string $initialMargin total initial margin requirement
     *
     * @return self
     */
     ...
     *
     * @param null|string $positionInitialMargin initial margin required for positions
     *
     * @return self
     */
     ...
     *
     * @param null|string $openOrderInitialMargin initial margin required for open orders
     *
     * @return self
     */
     ...
     *
     * @param null|string $crossWalletBalance cross wallet balance
     *
     * @return self
     */
     ...
     * Sets crossUnPnl.
     *
     * @param null|string $crossUnPnl unrealized PnL for cross positions
     *
     * @return self
     */
     ...
     *
     * @param null|bool $marginAvailable whether the asset can be used as margin in multi-assets mode
     *
     * @return self
     */
