...
class AccountInformationV3Response implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets assets.
     *
     * @param null|AccountInformationV3ResponseAssetsInner[] $assets asset-level account details
     *
     * @return self
     */
     ...
     * Sets positions.
     *
     * @param null|AccountInformationV3ResponsePositionsInner[] $positions position details for symbols
     *
     * @return self
     */
