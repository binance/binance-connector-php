 ...
 * @category Class
 *
 * @description positions of all symbols in the market are returned
 *
 * @author   OpenAPI Generator team
 *
 * @see     https://openapi-generator.tech
...
class AccountInformationV2ResponsePositionsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets isolated.
     *
     * @param null|bool $isolated whether the position uses isolated margin mode
     *
     * @return self
     */
     ...
     * Sets maxNotional.
     *
     * @param null|string $maxNotional maximum available notional under current leverage
     *
     * @return self
     */
     ...
     * Sets bidNotional.
     *
     * @param null|string $bidNotional bid notional (ignore)
     *
     * @return self
     */
