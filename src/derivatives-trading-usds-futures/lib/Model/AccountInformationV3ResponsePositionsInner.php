...
/**
 * AccountInformationV3ResponsePositionsInner Class Doc Comment.
 *
 * @category Class
 *
 * @description positions of all symbols user had position/ open orders are returned
 *
 * @author   OpenAPI Generator team
 *
 * @see     https://openapi-generator.tech
 ...
 */
class AccountInformationV3ResponsePositionsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'accountInformationV3Response_positions_inner';
     ...
     * Sets positionAmt.
     *
     * @param null|string $positionAmt position quantity
     *
     * @return self
     */
     ...
     * Sets notional.
     *
     * @param null|string $notional position notional value
     *
     * @return self
     */
     ...
     * Sets isolatedWallet.
     *
     * @param null|string $isolatedWallet isolated wallet balance
     *
     * @return self
     */
     ...
     * Sets initialMargin.
     *
     * @param null|string $initialMargin initial margin requirement
     *
     * @return self
     */
     ...
     * Sets maintMargin.
     *
     * @param null|string $maintMargin maintenance margin requirement
     *
     * @return self
     */
     ...
     * Sets updateTime.
     *
     * @param null|int $updateTime last update time in milliseconds
     *
     * @return self
     */
