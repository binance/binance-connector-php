...
/**
 * TestOrderRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class TestOrderRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'testOrderRequest';
    ...
    public function setCallbackRate($callbackRate)
    {
        ...
        if ($callbackRate > 5) {
            throw new \InvalidArgumentException('invalid value for $callbackRate when calling TestOrderRequest., must be smaller than or equal to 5.');
        }
        if ($callbackRate < 0.1) {
            throw new \InvalidArgumentException('invalid value for $callbackRate when calling TestOrderRequest., must be bigger than or equal to 0.1.');
        }
