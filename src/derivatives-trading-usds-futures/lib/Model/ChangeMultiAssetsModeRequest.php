...
/**
 * ChangeMultiAssetsModeRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class ChangeMultiAssetsModeRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'changeMultiAssetsModeRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['multiAssetsMargin']) {
            $invalidProperties[] = "'multiAssetsMargin' can't be null";
        }
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling ChangeMultiAssetsModeRequest., must be smaller than or equal to 60000.');
        }
