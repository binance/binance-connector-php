...
class CompressedAggregateTradesListResponseInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets a.
     *
     * @param null|int $a Aggregate tradeId
     *
     * @return self
     */
    ...
    {
        return $this->container['nq'];
    }

    /**
     * Sets nq.
     *
     * @param null|string $nq Normal quantity without the trades involving RPI orders
     *
     * @return self
     */
    public function setNq($nq)
    {
        if (is_null($nq)) {
            throw new \InvalidArgumentException('non-nullable nq cannot be null');
        }
        $this->container['nq'] = $nq;
     ...
     * Sets f.
     *
     * @param null|int $f First tradeId
     *
     * @return self
     */
     ...
     * Sets m.
     *
     * @param null|bool $m Was the buyer the maker?
     *
     * @return self
     */
