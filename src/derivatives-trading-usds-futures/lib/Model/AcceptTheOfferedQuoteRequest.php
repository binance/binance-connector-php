...
/**
 * AcceptTheOfferedQuoteRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class AcceptTheOfferedQuoteRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'acceptTheOfferedQuoteRequest';
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling AcceptTheOfferedQuoteRequest., must be smaller than or equal to 60000.');
        }
