...
class NewAlgoOrderRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'algoType' => '\Binance\Client\DerivativesTradingUsdsFutures\Model\AlgoType',
        'symbol' => 'string',
        'side' => '\Binance\Client\DerivativesTradingUsdsFutures\Model\Side',
        'positionSide' => 'string',
        'type' => '\Binance\Client\DerivativesTradingUsdsFutures\Model\OrderType',
        ...
        'closePosition' => '\Binance\Client\DerivativesTradingUsdsFutures\Model\ClosePosition',
        'priceProtect' => '\Binance\Client\DerivativesTradingUsdsFutures\Model\PriceProtect',
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['callbackRate']) && ($this->container['callbackRate'] > 10)) {
            $invalidProperties[] = "invalid value for 'callbackRate', must be smaller than or equal to 10.";
        }
     ...
     * Sets algoType.
     *
     * @param AlgoType $algoType algoType
     *
     * @return self
     */
     ...
     * Sets positionSide.
     *
     * @param null|string $positionSide Default `BOTH` for One-way Mode ; `LONG` or `SHORT` for Hedge Mode. It must be sent in Hedge Mode.
     *
     * @return self
     */
     ...
     * Sets quantity.
     *
     * @param null|float $quantity Cannot be sent with `closePosition`=`true`(Close-All)
     *
     * @return self
     */
     ...
     * Sets triggerPrice.
     *
     * @param null|float $triggerPrice Trigger price
     *
     * @return self
     */
     ...
     * Sets activatePrice.
     *
     * @param null|float $activatePrice Used with `TRAILING_STOP_MARKET` orders, default as the latest price(supporting different `workingType`)
     *
     * @return self
     */
    ...
    public function setCallbackRate($callbackRate)
    {
        ...
        if ($callbackRate > 10) {
            throw new \InvalidArgumentException('invalid value for $callbackRate when calling NewAlgoOrderRequest., must be smaller than or equal to 10.');
        }
        if ($callbackRate < 0.1) {
            throw new \InvalidArgumentException('invalid value for $callbackRate when calling NewAlgoOrderRequest., must be bigger than or equal to 0.1.');
        }
     ...
     * Sets clientAlgoId.
     *
     * @param null|string $clientAlgoId A unique id among open orders. Automatically generated if not sent. Can only be string following the rule: `^[\\.A-Z\\:/a-z0-9_-]{1,36}$`
     *
     * @return self
     */
     ...
     * Sets goodTillDate.
     *
     * @param null|int $goodTillDate order cancel time for timeInForce `GTD`, mandatory when `timeInforce` set to `GTD`; order the timestamp only retains second-level precision, ms part will be ignored; The goodTillDate timestamp must be greater than the current time plus 600 seconds and smaller than 253402300799000
     *
     * @return self
     */
