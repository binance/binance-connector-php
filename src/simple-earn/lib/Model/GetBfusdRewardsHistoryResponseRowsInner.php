...
/**
 * GetBfusdRewardsHistoryResponseRowsInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class GetBfusdRewardsHistoryResponseRowsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getBfusdRewardsHistoryResponse_rows_inner';
     ...
     * @return null|string
     */
    public function getBFUSDPosition()
    {
        return $this->container['bFUSDPosition'];
    }

    /**
     * Sets bFUSDPosition.
     *
     * @param null|string $bFUSDPosition bFUSDPosition
     *
     * @return self
     */
    public function setBFUSDPosition($bFUSDPosition)
    {
        if (is_null($bFUSDPosition)) {
            throw new \InvalidArgumentException('non-nullable bFUSDPosition cannot be null');
        }
        $this->container['bFUSDPosition'] = $bFUSDPosition;
