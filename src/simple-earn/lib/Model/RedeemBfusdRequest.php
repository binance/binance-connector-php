...
/**
 * RedeemBfusdRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class RedeemBfusdRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'redeemBfusdRequest';
    ...
    protected static $openAPITypes = [
        'amount' => 'float',
        'type' => '\Binance\Client\SimpleEarn\Model\OrderType',
        'recvWindow' => 'int',
    ];
     ...
     * Sets amount.
     *
     * @param float $amount Amount in BFUSD
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling RedeemBfusdRequest., must be smaller than or equal to 60000.');
        }
