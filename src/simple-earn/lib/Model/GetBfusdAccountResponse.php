...
/**
 * GetBfusdAccountResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class GetBfusdAccountResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getBfusdAccountResponse';
     ...
     * @return null|string
     */
    public function getBfusdAmount()
    {
        return $this->container['bfusdAmount'];
    }

    /**
     * Sets bfusdAmount.
     *
     * @param null|string $bfusdAmount bfusdAmount
     *
     * @return self
     */
    public function setBfusdAmount($bfusdAmount)
    {
        if (is_null($bfusdAmount)) {
            throw new \InvalidArgumentException('non-nullable bfusdAmount cannot be null');
        }
        $this->container['bfusdAmount'] = $bfusdAmount;
