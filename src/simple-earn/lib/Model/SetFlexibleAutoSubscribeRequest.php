...
/**
 * SetFlexibleAutoSubscribeRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class SetFlexibleAutoSubscribeRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'setFlexibleAutoSubscribeRequest';
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling SetFlexibleAutoSubscribeRequest., must be smaller than or equal to 60000.');
        }
