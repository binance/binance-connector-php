...
/**
 * SubscribeRwusdRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class SubscribeRwusdRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'subscribeRwusdRequest';
    ...
    protected static $openAPITypes = [
        'asset' => '\Binance\Client\SimpleEarn\Model\Asset',
        'amount' => 'float',
        'recvWindow' => 'int',
    ];
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling SubscribeRwusdRequest., must be smaller than or equal to 60000.');
        }
