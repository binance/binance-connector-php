...
/**
 * SetLockedProductRedeemOptionRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class SetLockedProductRedeemOptionRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'setLockedProductRedeemOptionRequest';
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling SetLockedProductRedeemOptionRequest., must be smaller than or equal to 60000.');
        }
