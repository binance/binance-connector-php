...
class SubscribeLockedProductRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'amount' => 'float',
        'autoSubscribe' => 'bool',
        'sourceAccount' => '\Binance\Client\SimpleEarn\Model\SourceAccount',
        'redeemTo' => '\Binance\Client\SimpleEarn\Model\RedeemTo',
        'recvWindow' => 'int',
    ];
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling SubscribeLockedProductRequest., must be smaller than or equal to 60000.');
        }
