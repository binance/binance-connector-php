...
/**
 * RedeemRwusdRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class RedeemRwusdRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'redeemRwusdRequest';
     ...
     * Sets amount.
     *
     * @param float $amount Amount in RWUSD
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling RedeemRwusdRequest., must be smaller than or equal to 60000.');
        }
