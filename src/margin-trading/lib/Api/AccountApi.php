...
class AccountApi
{
    ...
    public function disableIsolatedMarginAccountRequest($symbol, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.disableIsolatedMarginAccount, must be smaller than or equal to 60000.');
        }
    ...
    public function getSummaryOfMarginAccountRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.getSummaryOfMarginAccount, must be smaller than or equal to 60000.');
        }
    ...
    public function queryCrossIsolatedMarginCapitalFlowRequest($asset = null, $symbol = null, $type = null, $startTime = null, $endTime = null, $fromId = null, $limit = null, $recvWindow = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling AccountApi.queryCrossIsolatedMarginCapitalFlow, must be smaller than or equal to 1000.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.queryCrossIsolatedMarginCapitalFlow, must be smaller than or equal to 60000.');
        }
    ...
    public function queryCrossMarginAccountDetailsRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.queryCrossMarginAccountDetails, must be smaller than or equal to 60000.');
        }
    ...
    public function queryCrossMarginFeeDataRequest($vipLevel = null, $coin = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.queryCrossMarginFeeData, must be smaller than or equal to 60000.');
        }
    ...
    public function queryEnabledIsolatedMarginAccountLimitRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.queryEnabledIsolatedMarginAccountLimit, must be smaller than or equal to 60000.');
        }
     ...
     * Query Isolated Margin Account Info (USER_DATA)
     *
     * @param null|string $symbols    (optional)
     * @param null|int    $recvWindow (optional)
     *
     * @return ApiResponse<QueryIsolatedMarginAccountInfoResponse>
     *
    ...
    public function queryIsolatedMarginAccountInfoRequest($symbols = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.queryIsolatedMarginAccountInfo, must be smaller than or equal to 60000.');
        }
    ...
    public function queryIsolatedMarginFeeDataRequest($vipLevel = null, $symbol = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.queryIsolatedMarginFeeData, must be smaller than or equal to 60000.');
        }
