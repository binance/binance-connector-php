...
class MarketDataApi
{
    ...
    public function getAllIsolatedMarginSymbolRequest($symbol = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling MarketDataApi.getAllIsolatedMarginSymbol, must be smaller than or equal to 60000.');
        }
    ...
    public function getDelistScheduleRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling MarketDataApi.getDelistSchedule, must be smaller than or equal to 60000.');
        }
    ...
    public function getListScheduleRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling MarketDataApi.getListSchedule, must be smaller than or equal to 60000.');
        }
    ...
    public function queryIsolatedMarginTierDataRequest($symbol, $tier = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling MarketDataApi.queryIsolatedMarginTierData, must be smaller than or equal to 60000.');
        }
