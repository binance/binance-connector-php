...
class TradeApi
{
    ...
    public const contentTypes = [
        ...
        'exitSpecialKeyMode' => ['application/x-www-form-urlencoded'],
        ...
        'liquidationLoanRepay' => ['application/x-www-form-urlencoded'],
        ...
        'queryLiquidationLoan' => ['application/x-www-form-urlencoded'],
        'queryLiquidationLoanRepayHistory' => ['application/x-www-form-urlencoded'],
    ...
    public function deleteSpecialKeyRequest($apiName = null, $symbol = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.deleteSpecialKey, must be smaller than or equal to 60000.');
        }
    ...
    {
        return $this->exitSpecialKeyModeWithHttpInfo($exitSpecialKeyModeRequest);
    }

    /**
     * Operation exitSpecialKeyModeWithHttpInfo.
     *
     * Exit Special Key Mode (TRADE)
     *
     * @param null|ExitSpecialKeyModeRequest $exitSpecialKeyModeRequest (optional)
     *
     * @return ApiResponse<object>
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function exitSpecialKeyModeWithHttpInfo($exitSpecialKeyModeRequest = null): ApiResponse
    {
        $request = $this->exitSpecialKeyModeRequest($exitSpecialKeyModeRequest);
    ...
    /**
     * Create request for operation 'exitSpecialKeyMode'.
     *
     * @param null|ExitSpecialKeyModeRequest $exitSpecialKeyModeRequest (optional)
     *
     * @return Request
     ...
     * @throws \InvalidArgumentException
     */
    public function exitSpecialKeyModeRequest($exitSpecialKeyModeRequest = null)
    {
        $contentType = self::contentTypes['exitSpecialKeyMode'][0];

        $resourcePath = '/sapi/v1/margin/exit-special-key-mode';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $getters = $exitSpecialKeyModeRequest::getters();
        $formParams = [];
        foreach ($getters as $property => $getter) {
            $value = $exitSpecialKeyModeRequest->{$getter}();
            if (!empty($value)) {
                $formParams[$property] = $exitSpecialKeyModeRequest->{$getter}();
            }
        }
        ...
        } elseif (isset($exitSpecialKeyModeRequest)) {
            if (false !== stripos($headers['Content-Type'], 'application/json')) {
                // if Content-Type contains "application/json", json_encode the body
                $httpBody = Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($exitSpecialKeyModeRequest));
            } else {
                $httpBody = $exitSpecialKeyModeRequest;
            }
        }
    ...
    public function getForceLiquidationRecordRequest($startTime = null, $endTime = null, $isolatedSymbol = null, $current = null, $size = null, $recvWindow = null)
    {
        ...
        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling TradeApi.getForceLiquidationRecord, must be bigger than or equal to 1.');
        }

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling TradeApi.getForceLiquidationRecord, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.getForceLiquidationRecord, must be smaller than or equal to 60000.');
        }
    ...
    public function getSmallLiabilityExchangeCoinListRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.getSmallLiabilityExchangeCoinList, must be smaller than or equal to 60000.');
        }
    ...
    public function getSmallLiabilityExchangeHistoryRequest($current, $size, $startTime = null, $endTime = null, $recvWindow = null)
    {
        ...
        if ($current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling TradeApi.getSmallLiabilityExchangeHistory, must be bigger than or equal to 1.');
        }
        ...
        if ($size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling TradeApi.getSmallLiabilityExchangeHistory, must be smaller than or equal to 100.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.getSmallLiabilityExchangeHistory, must be smaller than or equal to 60000.');
        }
    ...
    {
        return $this->liquidationLoanRepayWithHttpInfo($liquidationLoanRepayRequest);
    }

    /**
     * Operation liquidationLoanRepayWithHttpInfo.
     *
     * Liquidation Loan Repay (MARGIN)
     *
     * @param LiquidationLoanRepayRequest $liquidationLoanRepayRequest (required)
     *
     * @return ApiResponse<LiquidationLoanRepayResponse>
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function liquidationLoanRepayWithHttpInfo($liquidationLoanRepayRequest): ApiResponse
    {
        $request = $this->liquidationLoanRepayRequest($liquidationLoanRepayRequest);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Binance\Client\MarginTrading\Model\LiquidationLoanRepayResponse',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Create request for operation 'liquidationLoanRepay'.
     *
     * @param LiquidationLoanRepayRequest $liquidationLoanRepayRequest (required)
     *
     * @return Request
     ...
     * @throws \InvalidArgumentException
     */
    public function liquidationLoanRepayRequest($liquidationLoanRepayRequest)
    {
        $contentType = self::contentTypes['liquidationLoanRepay'][0];

        // verify the required parameter 'liquidationLoanRepayRequest' is set
        if (null === $liquidationLoanRepayRequest || (is_array($liquidationLoanRepayRequest) && 0 === count($liquidationLoanRepayRequest))) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $liquidationLoanRepayRequest when calling liquidationLoanRepay'
            );
        }

        $resourcePath = '/sapi/v1/margin/liquidation-loan/repay';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $getters = $liquidationLoanRepayRequest::getters();
        $formParams = [];
        foreach ($getters as $property => $getter) {
            $value = $liquidationLoanRepayRequest->{$getter}();
            if (!empty($value)) {
                $formParams[$property] = $liquidationLoanRepayRequest->{$getter}();
            }
        }
        ...
        } elseif (isset($liquidationLoanRepayRequest)) {
            if (false !== stripos($headers['Content-Type'], 'application/json')) {
                // if Content-Type contains "application/json", json_encode the body
                $httpBody = Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($liquidationLoanRepayRequest));
            } else {
                $httpBody = $liquidationLoanRepayRequest;
            }
        }
     ...
     * @param null|IsIsolated $isIsolated (optional)
     * @param null|int        $recvWindow (optional)
     *
     * @return ApiResponse<MarginAccountCancelAllOpenOrdersOnASymbolResponse>
     *
    ...
    public function marginAccountCancelAllOpenOrdersOnASymbolRequest($symbol, $isIsolated = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.marginAccountCancelAllOpenOrdersOnASymbol, must be smaller than or equal to 60000.');
        }
     ...
     * @param string          $symbol            (required)
     * @param null|IsIsolated $isIsolated        (optional)
     * @param null|int        $orderListId       (optional)
     * @param null|string     $listClientOrderId (optional)
     * @param null|string     $newClientOrderId  (optional)
     * @param null|int        $recvWindow        (optional)
     *
     * @return ApiResponse<MarginAccountCancelOcoResponse>
     *
    ...
    public function marginAccountCancelOcoRequest($symbol, $isIsolated = null, $orderListId = null, $listClientOrderId = null, $newClientOrderId = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.marginAccountCancelOco, must be smaller than or equal to 60000.');
        }
    ...
    public function marginAccountCancelOrderRequest($symbol, $isIsolated = null, $orderId = null, $origClientOrderId = null, $newClientOrderId = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.marginAccountCancelOrder, must be smaller than or equal to 60000.');
        }
    ...
    public function queryCurrentMarginOrderCountUsageRequest($isIsolated = null, $symbol = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.queryCurrentMarginOrderCountUsage, must be smaller than or equal to 60000.');
        }
    ...
    {
        return $this->queryLiquidationLoanWithHttpInfo($recvWindow);
    }

    /**
     * Operation queryLiquidationLoanWithHttpInfo.
     *
     * Query Liquidation Loan (USER_DATA)
     *
     * @param null|int $recvWindow (optional)
     ...
     * @throws \InvalidArgumentException
     */
    public function queryLiquidationLoanWithHttpInfo($recvWindow = null): ApiResponse
    {
        $request = $this->queryLiquidationLoanRequest($recvWindow);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Binance\Client\MarginTrading\Model\QueryLiquidationLoanResponse',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Create request for operation 'queryLiquidationLoan'.
     *
     * @param null|int $recvWindow (optional)
     *
     * @return Request
     ...
     * @throws \InvalidArgumentException
     */
    public function queryLiquidationLoanRequest($recvWindow = null)
    {
        $contentType = self::contentTypes['queryLiquidationLoan'][0];

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.queryLiquidationLoan, must be smaller than or equal to 60000.');
        }

        $resourcePath = '/sapi/v1/margin/liquidation-loan';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        return $this->queryLiquidationLoanRepayHistoryWithHttpInfo($startTime, $endTime, $current, $size, $recvWindow);
    }

    /**
     * Operation queryLiquidationLoanRepayHistoryWithHttpInfo.
     *
     * Query Liquidation Loan Repay History (USER_DATA)
     *
     * @param null|int $startTime  Start time in Unix timestamp (milliseconds). Defaults to 7 days ago if not specified (optional)
     ...
     * @throws \InvalidArgumentException
     */
    public function queryLiquidationLoanRepayHistoryWithHttpInfo($startTime = null, $endTime = null, $current = null, $size = null, $recvWindow = null): ApiResponse
    {
        $request = $this->queryLiquidationLoanRepayHistoryRequest($startTime, $endTime, $current, $size, $recvWindow);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Binance\Client\MarginTrading\Model\QueryLiquidationLoanRepayHistoryResponse',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Create request for operation 'queryLiquidationLoanRepayHistory'.
     *
     * @param null|int $startTime  Start time in Unix timestamp (milliseconds). Defaults to 7 days ago if not specified (optional)
     * @param null|int $endTime    End time in Unix timestamp (milliseconds). Defaults to now if not specified (optional)
     * @param null|int $current    Current page number, default &#x60;1&#x60; (optional)
     ...
     * @throws \InvalidArgumentException
     */
    public function queryLiquidationLoanRepayHistoryRequest($startTime = null, $endTime = null, $current = null, $size = null, $recvWindow = null)
    {
        $contentType = self::contentTypes['queryLiquidationLoanRepayHistory'][0];

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.queryLiquidationLoanRepayHistory, must be smaller than or equal to 60000.');
        }

        $resourcePath = '/sapi/v1/margin/liquidation-loan/repay-history';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param null|IsIsolated $isIsolated (optional)
     * @param null|string     $symbol     (optional)
     * @param null|int        $fromId     (optional)
     * @param null|int        $startTime  (optional)
     * @param null|int        $endTime    (optional)
    ...
    public function queryMarginAccountsAllOcoRequest($isIsolated = null, $symbol = null, $fromId = null, $startTime = null, $endTime = null, $limit = null, $recvWindow = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling TradeApi.queryMarginAccountsAllOco, must be smaller than or equal to 1000.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.queryMarginAccountsAllOco, must be smaller than or equal to 60000.');
        }
    ...
    public function queryMarginAccountsAllOrdersRequest($symbol, $isIsolated = null, $orderId = null, $startTime = null, $endTime = null, $limit = null, $recvWindow = null)
    {
        ...
        if (null !== $limit && $limit > 500) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling TradeApi.queryMarginAccountsAllOrders, must be smaller than or equal to 500.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.queryMarginAccountsAllOrders, must be smaller than or equal to 60000.');
        }
    ...
    public function queryMarginAccountsOcoRequest($isIsolated = null, $symbol = null, $orderListId = null, $origClientOrderId = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.queryMarginAccountsOco, must be smaller than or equal to 60000.');
        }
    ...
    public function queryMarginAccountsOpenOcoRequest($isIsolated = null, $symbol = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.queryMarginAccountsOpenOco, must be smaller than or equal to 60000.');
        }
    ...
    public function queryMarginAccountsOpenOrdersRequest($symbol = null, $isIsolated = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.queryMarginAccountsOpenOrders, must be smaller than or equal to 60000.');
        }
    ...
    public function queryMarginAccountsOrderRequest($symbol, $isIsolated = null, $orderId = null, $origClientOrderId = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.queryMarginAccountsOrder, must be smaller than or equal to 60000.');
        }
    ...
    public function queryMarginAccountsTradeListRequest($symbol, $isIsolated = null, $orderId = null, $startTime = null, $endTime = null, $fromId = null, $limit = null, $recvWindow = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling TradeApi.queryMarginAccountsTradeList, must be smaller than or equal to 1000.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.queryMarginAccountsTradeList, must be smaller than or equal to 60000.');
        }
    ...
    {
        return $this->queryPreventedMatchesWithHttpInfo($symbol, $preventedMatchId, $orderId, $fromPreventedMatchId, $isIsolated, $recvWindow);
    }
     ...
     * @throws \InvalidArgumentException
     */
    public function queryPreventedMatchesWithHttpInfo($symbol, $preventedMatchId = null, $orderId = null, $fromPreventedMatchId = null, $isIsolated = null, $recvWindow = null): ApiResponse
    {
        $request = $this->queryPreventedMatchesRequest($symbol, $preventedMatchId, $orderId, $fromPreventedMatchId, $isIsolated, $recvWindow);
     ...
     * @throws \InvalidArgumentException
     */
    public function queryPreventedMatchesRequest($symbol, $preventedMatchId = null, $orderId = null, $fromPreventedMatchId = null, $isIsolated = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.queryPreventedMatches, must be smaller than or equal to 60000.');
        }
    ...
    public function querySpecialKeyRequest($symbol = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.querySpecialKey, must be smaller than or equal to 60000.');
        }
    ...
    public function querySpecialKeyListRequest($symbol = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TradeApi.querySpecialKeyList, must be smaller than or equal to 60000.');
        }
