...
/**
 * LiquidationLoanRepayRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class LiquidationLoanRepayRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'liquidationLoanRepayRequest';
     ...
     * Sets amount.
     *
     * @param float $amount Repayment amount, must be greater than 0
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling LiquidationLoanRepayRequest., must be smaller than or equal to 60000.');
        }
