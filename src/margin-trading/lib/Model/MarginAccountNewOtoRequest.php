...
class MarginAccountNewOtoRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'pendingType' => '\Binance\Client\MarginTrading\Model\PendingType',
        ...
        'pendingTimeInForce' => '\Binance\Client\MarginTrading\Model\PendingTimeInForce',
    ];
     ...
     *
     * @param float $workingIcebergQty this can only be used if `workingTimeInForce` is `GTC`
     *
     * @return self
     */
     ...
     *
     * @param float $pendingQuantity sets the quantity for the pending order
     *
     * @return self
     */
     ...
     *
     * @param null|float $pendingIcebergQty this can only be used if `pendingTimeInForce` is `GTC`
     *
     * @return self
     */
