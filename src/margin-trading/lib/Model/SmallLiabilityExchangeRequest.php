...
/**
 * SmallLiabilityExchangeRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class SmallLiabilityExchangeRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'smallLiabilityExchangeRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['assetNames']) {
            $invalidProperties[] = "'assetNames' can't be null";
        }
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling SmallLiabilityExchangeRequest., must be smaller than or equal to 60000.');
        }
