...
/**
 * QueryCurrentMarginOrderCountUsageResponseInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class QueryCurrentMarginOrderCountUsageResponseInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'queryCurrentMarginOrderCountUsageResponse_inner';
     ...
     * Sets intervalNum.
     *
     * @param null|int $intervalNum interval Num
     *
     * @return self
     */
