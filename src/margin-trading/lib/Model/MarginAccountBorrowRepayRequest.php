...
/**
 * MarginAccountBorrowRepayRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class MarginAccountBorrowRepayRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'marginAccountBorrowRepayRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['isIsolated']) {
            $invalidProperties[] = "'isIsolated' can't be null";
        }
     ...
     * Sets isIsolated.
     *
     * @param IsIsolated $isIsolated isIsolated
     *
     * @return self
     */
     ...
     * Sets symbol.
     *
     * @param null|string $symbol Only for Isolated margin
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling MarginAccountBorrowRepayRequest., must be smaller than or equal to 60000.');
        }
