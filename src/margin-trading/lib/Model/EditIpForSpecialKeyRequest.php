...
/**
 * EditIpForSpecialKeyRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class EditIpForSpecialKeyRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'editIpForSpecialKeyRequest';
     ...
     * Sets symbol.
     *
     * @param null|string $symbol isolated margin pair
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling EditIpForSpecialKeyRequest., must be smaller than or equal to 60000.');
        }
