...
class CreateSpecialKeyRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'ip' => 'string',
        'publicKey' => 'string',
        'permissionMode' => '\Binance\Client\MarginTrading\Model\PermissionMode',
        'recvWindow' => 'int',
    ];
     ...
     * Sets ip.
     *
     * @param null|string $ip Can be added in batches, separated by commas. Max 30 for an API key
     *
     * @return self
     */
     ...
     * Sets publicKey.
     *
     * @param null|string $publicKey 1. If publicKey is inputted it will create an RSA or Ed25519 key.  2. Need to be encoded to URL-encoded format
     *
     * @return self
     */
     ...
     * Sets permissionMode.
     *
     * @param null|PermissionMode $permissionMode permissionMode
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling CreateSpecialKeyRequest., must be smaller than or equal to 60000.');
        }
