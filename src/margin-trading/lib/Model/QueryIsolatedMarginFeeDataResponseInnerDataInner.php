...
/**
 * QueryIsolatedMarginFeeDataResponseInnerDataInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class QueryIsolatedMarginFeeDataResponseInnerDataInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'queryIsolatedMarginFeeDataResponse_inner_data_inner';
     ...
     * Sets dailyInterest.
     *
     * @param null|string $dailyInterest daily Interest
     *
     * @return self
     */
     ...
     * Sets borrowLimit.
     *
     * @param null|string $borrowLimit borrow Limit
     *
     * @return self
     */
