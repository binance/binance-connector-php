...
class MarginAccountNewOcoRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'stopLimitTimeInForce' => '\Binance\Client\MarginTrading\Model\StopLimitTimeInForce',
     ...
     *
     * @param null|bool $autoRepayAtCancel only when MARGIN_BUY or AUTO_BORROW_REPAY order takes effect, true means that the debt generated by the order needs to be repay after the order is cancelled
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling MarginAccountNewOcoRequest., must be smaller than or equal to 60000.');
        }
