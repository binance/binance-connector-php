...
class MarginAccountNewOrderRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'type' => '\Binance\Client\MarginTrading\Model\OrderType',
        'quantity' => 'float',
        'quoteOrderQty' => 'float',
        'price' => 'float',
        'stopPrice' => 'float',
     ...
     *
     * @param null|string $newClientOrderId A unique id among open orders. Automatically generated if not sent.
     *
     * @return self
     */
     ...
     * Sets trailingDelta.
     *
     * @param null|int $trailingDelta used with `STOP_LOSS`, `STOP_LOSS_LIMIT`, `TAKE_PROFIT`, and `TAKE_PROFIT_LIMIT` orders
     *
     * @return self
     */
     ...
     *
     * @param null|bool $autoRepayAtCancel only when MARGIN_BUY or AUTO_BORROW_REPAY order takes effect, true means that the debt generated by the order needs to be repaid after the order is cancelled
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling MarginAccountNewOrderRequest., must be smaller than or equal to 60000.');
        }
