...
/**
 * CreateSpecialKeyResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class CreateSpecialKeyResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createSpecialKeyResponse';
     ...
     * Sets secretKey.
     *
     * @param null|string $secretKey secretKey will be null when creating an RSA key
     *
     * @return self
     */
     ...
     * Sets type.
     *
     * @param null|string $type HMAC_SHA256 or RSA
     *
     * @return self
     */
