...
class QueryLiabilityCoinLeverageBracketInCrossMarginProModeResponseInnerBracketsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets maxDebt.
     *
     * @param null|float $maxDebt max Debt
     *
     * @return self
     */
     ...
     *
     * @param null|float $maintenanceMarginRate maintenance Margin Rate
     *
     * @return self
     */
     ...
     *
     * @param null|float $initialMarginRate initial Margin Rate
     *
     * @return self
     */
     ...
     * Sets fastNum.
     *
     * @param null|float $fastNum fast Num
     *
     * @return self
     */
