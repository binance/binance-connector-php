...
/**
 * QueryLiquidationLoanResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class QueryLiquidationLoanResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'queryLiquidationLoanResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('repaidAmount', $data ?? [], null);
     ...
     * Sets asset.
     *
     * @param null|string $asset The asset of the liquidation loan (USDC by default)
     *
     * @return self
     */
     ...
     * Sets amount.
     *
     * @param null|string $amount Total liquidation loan amount
     *
     * @return self
     */
     ...
     * Sets repaidAmount.
     *
     * @param null|string $repaidAmount Amount that has been repaid
     *
     * @return self
     */
    public function setRepaidAmount($repaidAmount)
    {
        if (is_null($repaidAmount)) {
            throw new \InvalidArgumentException('non-nullable repaidAmount cannot be null');
        }
     ...
     *
     * @param null|string $remainingAmount Outstanding amount remaining to be repaid
     *
     * @return self
     */
