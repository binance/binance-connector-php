...
/**
 * MarginManualLiquidationRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class MarginManualLiquidationRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'marginManualLiquidationRequest';
     ...
     * Sets symbol.
     *
     * @param null|string $symbol When type selects `ISOLATED`, `symbol` must be filled in
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling MarginManualLiquidationRequest., must be smaller than or equal to 60000.');
        }
