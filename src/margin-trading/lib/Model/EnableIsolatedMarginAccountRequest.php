...
/**
 * EnableIsolatedMarginAccountRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class EnableIsolatedMarginAccountRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'enableIsolatedMarginAccountRequest';
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling EnableIsolatedMarginAccountRequest., must be smaller than or equal to 60000.');
        }
