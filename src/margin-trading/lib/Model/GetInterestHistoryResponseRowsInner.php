...
/**
 * GetInterestHistoryResponseRowsInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class GetInterestHistoryResponseRowsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getInterestHistoryResponse_rows_inner';
     ...
     *
     * @param null|int $interestAccuredTime interest Accured Time
     *
     * @return self
     */
     ...
     * Sets rawAsset.
     *
     * @param null|string $rawAsset will not be returned for isolated margin
     *
     * @return self
     */
