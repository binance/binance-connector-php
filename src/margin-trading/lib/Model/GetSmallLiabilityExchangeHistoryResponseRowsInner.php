...
/**
 * GetSmallLiabilityExchangeHistoryResponseRowsInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class GetSmallLiabilityExchangeHistoryResponseRowsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getSmallLiabilityExchangeHistoryResponse_rows_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bizType', $data ?? [], null);
     ...
     * Sets targetAsset.
     *
     * @param null|string $targetAsset target Asset
     *
     * @return self
     */
     ...
     * Sets targetAmount.
     *
     * @param null|string $targetAmount target Amount
     *
     * @return self
     */
     ...
     * Sets bizType.
     *
     * @param null|string $bizType biz Type
     *
     * @return self
     */
    ...
    {
        if (is_null($bizType)) {
            throw new \InvalidArgumentException('non-nullable bizType cannot be null');
        }
