...
class VipLoanBorrowRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets isFlexibleRate.
     *
     * @param bool $isFlexibleRate TRUE: flexible rate; FALSE: fixed rate
     *
     * @return self
     */
     ...
     * Sets loanTerm.
     *
     * @param null|int $loanTerm Mandatory for fixed rate. Optional for flexible rate. e.g. 30/60 days
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling VipLoanBorrowRequest., must be smaller than or equal to 60000.');
        }
