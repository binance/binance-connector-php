...
/**
 * VipLoanBorrowResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class VipLoanBorrowResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'vipLoanBorrowResponse';
     ...
     * Sets loanAccountId.
     *
     * @param null|string $loanAccountId loan receiving account
     *
     * @return self
     */
     ...
     * Sets isFlexibleRate.
     *
     * @param null|string $isFlexibleRate isFlexibleRate
     *
     * @return self
     */
