...
class GetVIPLoanOngoingOrdersResponseRowsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets loanRate.
     *
     * @param null|string $loanRate for flexible loans, this is the flexible rate
     *
     * @return self
     */
     ...
     * Sets expirationTime.
     *
     * @param null|int $expirationTime for flexible loans, this value is `0`
     *
     * @return self
     */
     ...
     * Sets loanTerm.
     *
     * @param null|string $loanTerm for flexible loans, this value is `open term`
     *
     * @return self
     */
