...
/**
 * QueryHistoricalAlgoOrdersFutureAlgoResponseOrdersInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class QueryHistoricalAlgoOrdersFutureAlgoResponseOrdersInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'queryHistoricalAlgoOrdersFutureAlgoResponse_orders_inner';
     ...
     * Sets totalQty.
     *
     * @param null|string $totalQty Total order quantity
     *
     * @return self
     */
     ...
     * Sets clientAlgoId.
     *
     * @param null|string $clientAlgoId Client-defined algo order ID
     *
     * @return self
     */
     ...
     * Sets endTime.
     *
     * @param null|int $endTime End time
     *
     * @return self
     */
     ...
     * Sets algoStatus.
     *
     * @param null|string $algoStatus Algo order status
     *
     * @return self
     */
     ...
     * Sets algoType.
     *
     * @param null|string $algoType Algo order type
     *
     * @return self
     */
     ...
     * Sets urgency.
     *
     * @param null|string $urgency Execution urgency
     *
     * @return self
     */
