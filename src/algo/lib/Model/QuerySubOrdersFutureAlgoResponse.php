...
/**
 * QuerySubOrdersFutureAlgoResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class QuerySubOrdersFutureAlgoResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'querySubOrdersFutureAlgoResponse';
    ...
    protected static $openAPITypes = [
        ...
        'executedQty' => 'string',
        'executedAmt' => 'string',
        'subOrders' => '\Binance\Client\Algo\Model\QuerySubOrdersFutureAlgoResponseSubOrdersInner[]',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('subOrders', $data ?? [], null);
    }
     ...
     * Gets subOrders.
     *
     * @return null|QuerySubOrdersFutureAlgoResponseSubOrdersInner[]
     */
    public function getSubOrders()
    {
        return $this->container['subOrders'];
    }

    /**
     * Sets subOrders.
     *
     * @param null|QuerySubOrdersFutureAlgoResponseSubOrdersInner[] $subOrders subOrders
     *
     * @return self
     */
    public function setSubOrders($subOrders)
    {
        if (is_null($subOrders)) {
            throw new \InvalidArgumentException('non-nullable subOrders cannot be null');
        }
        $this->container['subOrders'] = $subOrders;
