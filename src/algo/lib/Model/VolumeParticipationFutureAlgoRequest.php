...
class VolumeParticipationFutureAlgoRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'quantity' => 'float',
        'urgency' => '\Binance\Client\Algo\Model\Urgency',
        'clientAlgoId' => 'string',
        'reduceOnly' => 'bool',
        'limitPrice' => 'float',
        'recvWindow' => 'int',
     ...
     * Sets quantity.
     *
     * @param float $quantity Quantity of base asset; The notional (`quantity` * `mark price(base asset)`) must be more than the equivalent of 10,000 USDT and less than the equivalent of 1,000,000 USDT
     *
     * @return self
     */
    ...
    public function setClientAlgoId($clientAlgoId)
    {
        ...
        if (mb_strlen($clientAlgoId) > 32) {
            throw new \InvalidArgumentException('invalid length for $clientAlgoId when calling VolumeParticipationFutureAlgoRequest., must be smaller than or equal to 32.');
        }
        if (mb_strlen($clientAlgoId) < 32) {
            throw new \InvalidArgumentException('invalid length for $clientAlgoId when calling VolumeParticipationFutureAlgoRequest., must be bigger than or equal to 32.');
        }
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling VolumeParticipationFutureAlgoRequest., must be smaller than or equal to 60000.');
        }
