...
class SpotAlgoApi
{
    ...
    public function queryCurrentAlgoOpenOrdersSpotAlgoRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling SpotAlgoApi.queryCurrentAlgoOpenOrdersSpotAlgo, must be smaller than or equal to 60000.');
        }
    ...
    public function queryHistoricalAlgoOrdersSpotAlgoRequest($symbol = null, $side = null, $startTime = null, $endTime = null, $page = null, $pageSize = null, $recvWindow = null)
    {
        ...
        if (null !== $pageSize && $pageSize > 100) {
            throw new \InvalidArgumentException('invalid value for "$pageSize" when calling SpotAlgoApi.queryHistoricalAlgoOrdersSpotAlgo, must be smaller than or equal to 100.');
        }
        if (null !== $pageSize && $pageSize < 1) {
            throw new \InvalidArgumentException('invalid value for "$pageSize" when calling SpotAlgoApi.queryHistoricalAlgoOrdersSpotAlgo, must be bigger than or equal to 1.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling SpotAlgoApi.queryHistoricalAlgoOrdersSpotAlgo, must be smaller than or equal to 60000.');
        }
    ...
    public function querySubOrdersSpotAlgoRequest($algoId, $page = null, $pageSize = null, $recvWindow = null)
    {
        ...
        if (null !== $pageSize && $pageSize > 100) {
            throw new \InvalidArgumentException('invalid value for "$pageSize" when calling SpotAlgoApi.querySubOrdersSpotAlgo, must be smaller than or equal to 100.');
        }
        if (null !== $pageSize && $pageSize < 1) {
            throw new \InvalidArgumentException('invalid value for "$pageSize" when calling SpotAlgoApi.querySubOrdersSpotAlgo, must be bigger than or equal to 1.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling SpotAlgoApi.querySubOrdersSpotAlgo, must be smaller than or equal to 60000.');
        }
