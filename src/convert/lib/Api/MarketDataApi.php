...
class MarketDataApi
{
    ...
    public function queryOrderQuantityPrecisionPerAssetRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling MarketDataApi.queryOrderQuantityPrecisionPerAsset, must be smaller than or equal to 60000.');
        }
