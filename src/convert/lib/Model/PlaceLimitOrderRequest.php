...
class PlaceLimitOrderRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'baseAmount' => 'float',
        'quoteAmount' => 'float',
        'side' => '\Binance\Client\Convert\Model\Side',
        'walletType' => '\Binance\Client\Convert\Model\WalletType',
        'expiredType' => '\Binance\Client\Convert\Model\ExpiredType',
        'recvWindow' => 'int',
    ];
     ...
     * Sets limitPrice.
     *
     * @param float $limitPrice Symbol limit price (from baseAsset to quoteAsset)
     *
     * @return self
     */
     ...
     * Sets baseAmount.
     *
     * @param null|float $baseAmount Base asset amount. (One of `baseAmount` or `quoteAmount` is required)
     *
     * @return self
     */
     ...
     * Sets quoteAmount.
     *
     * @param null|float $quoteAmount Quote asset amount. (One of `baseAmount` or `quoteAmount` is required)
     *
     * @return self
     */
     ...
     * Sets expiredType.
     *
     * @param ExpiredType $expiredType expiredType
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling PlaceLimitOrderRequest., must be smaller than or equal to 60000.');
        }
