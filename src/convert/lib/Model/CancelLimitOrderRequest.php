...
/**
 * CancelLimitOrderRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class CancelLimitOrderRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'cancelLimitOrderRequest';
     ...
     * Sets orderId.
     *
     * @param int $orderId The orderId from `placeOrder` api
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling CancelLimitOrderRequest., must be smaller than or equal to 60000.');
        }
