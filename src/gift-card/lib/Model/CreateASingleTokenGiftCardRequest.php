...
/**
 * CreateASingleTokenGiftCardRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class CreateASingleTokenGiftCardRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createASingleTokenGiftCardRequest';
     ...
     * Sets amount.
     *
     * @param float $amount The amount of the token contained in the Binance Gift Card
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling CreateASingleTokenGiftCardRequest., must be smaller than or equal to 60000.');
        }
