...
class MarketDataApi
{
    ...
    public function fetchRsaPublicKeyRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling MarketDataApi.fetchRsaPublicKey, must be smaller than or equal to 60000.');
        }
    ...
    public function fetchTokenLimitRequest($baseToken, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling MarketDataApi.fetchTokenLimit, must be smaller than or equal to 60000.');
        }
    ...
    public function verifyBinanceGiftCardByGiftCardNumberRequest($referenceNo, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling MarketDataApi.verifyBinanceGiftCardByGiftCardNumber, must be smaller than or equal to 60000.');
        }
