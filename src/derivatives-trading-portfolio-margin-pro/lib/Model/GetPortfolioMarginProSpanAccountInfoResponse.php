...
class GetPortfolioMarginProSpanAccountInfoResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets uniMMR.
     *
     * @param null|string $uniMMR uni MMR
     *
     * @return self
     */
     ...
     *
     * @param null|string $accountMaintMargin Account maintenance margin, unit：USD
     *
     * @return self
     */
     ...
     * Sets marginMM.
     *
     * @param null|string $marginMM margin MM
     *
     * @return self
     */
     ...
     * Sets otherMM.
     *
     * @param null|string $otherMM other MM
     *
     * @return self
     */
     ...
     * Sets accountType.
     *
     * @param null|string $accountType PM_1 for classic PM, PM_2 for PM, PM_3 for PM Pro(SPAN)
     *
     * @return self
     */
