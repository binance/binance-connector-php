...
/**
 * GetPortfolioMarginProAccountInfoResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class GetPortfolioMarginProAccountInfoResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getPortfolioMarginProAccountInfoResponse';
     ...
     * Sets uniMMR.
     *
     * @param null|string $uniMMR Classic Portfolio margin account maintenance margin rate
     *
     * @return self
     */
     ...
     * Sets accountEquity.
     *
     * @param null|string $accountEquity Account equity, unit：USD
     *
     * @return self
     */
     ...
     * Sets actualEquity.
     *
     * @param null|string $actualEquity Actual equity, unit：USD
     *
     * @return self
     */
     ...
     *
     * @param null|string $accountMaintMargin Classic Portfolio margin account maintenance margin, unit：USD
     *
     * @return self
     */
     ...
     *
     * @param null|string $accountInitialMargin Ignored for PM PRO and PM PRO SPAN
     *
     * @return self
     */
     ...
     *
     * @param null|string $totalAvailableBalance Ignored for PM PRO and PM PRO SPAN
     *
     * @return self
     */
     ...
     * Sets accountStatus.
     *
     * @param null|string $accountStatus Classic Portfolio margin account status:\"NORMAL\", \"MARGIN_CALL\", \"SUPPLY_MARGIN\", \"REDUCE_ONLY\", \"ACTIVE_LIQUIDATION\", \"FORCE_LIQUIDATION\", \"BANKRUPTED\"
     *
     * @return self
     */
     ...
     * Sets accountType.
     *
     * @param null|string $accountType PM_1 for PM PRO, PM_2 for PM, PM_3 for PM PRO SPAN
     *
     * @return self
     */
