...
class TransferLdusdtRwusdForPortfolioMarginRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'asset' => '\Binance\Client\DerivativesTradingPortfolioMarginPro\Model\Asset',
        'transferType' => '\Binance\Client\DerivativesTradingPortfolioMarginPro\Model\TransferType',
        'amount' => 'float',
        'recvWindow' => 'int',
    ];
