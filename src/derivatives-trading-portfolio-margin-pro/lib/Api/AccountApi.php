...
class AccountApi
{
    ...
    public function deleteMarginCallLevelRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.deleteMarginCallLevel, must be smaller than or equal to 60000.');
        }
    ...
    public function getMarginCallLevelRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling AccountApi.getMarginCallLevel, must be smaller than or equal to 60000.');
        }
     ...
     *
     * @param string       $asset        &#x60;LDUSDT&#x60; only (required)
     * @param TransferType $transferType (required)
     * @param null|int     $recvWindow   (optional)
     *
     * @return ApiResponse<GetTransferableEarnAssetBalanceForPortfolioMarginResponse>
     *
     ...
     * Portfolio Margin Pro Bankruptcy Loan Repay (TRADE)
     *
     * @param null|PortfolioMarginProBankruptcyLoanRepayRequest $portfolioMarginProBankruptcyLoanRepayRequest (optional)
     *
     * @return ApiResponse<PortfolioMarginProBankruptcyLoanRepayResponse>
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function portfolioMarginProBankruptcyLoanRepayWithHttpInfo($portfolioMarginProBankruptcyLoanRepayRequest = null): ApiResponse
    {
     ...
     * @throws \InvalidArgumentException
     */
    public function portfolioMarginProBankruptcyLoanRepayRequest($portfolioMarginProBankruptcyLoanRepayRequest = null)
    {
    ...
    {
        return $this->queryPortfolioMarginProBankruptcyLoanRepayHistoryWithHttpInfo($startTime, $endTime, $size, $current, $recvWindow);
    }
     ...
     * @throws \InvalidArgumentException
     */
    public function queryPortfolioMarginProBankruptcyLoanRepayHistoryWithHttpInfo($startTime = null, $endTime = null, $size = null, $current = null, $recvWindow = null): ApiResponse
    {
        $request = $this->queryPortfolioMarginProBankruptcyLoanRepayHistoryRequest($startTime, $endTime, $size, $current, $recvWindow);
     ...
     * @throws \InvalidArgumentException
     */
    public function queryPortfolioMarginProBankruptcyLoanRepayHistoryRequest($startTime = null, $endTime = null, $size = null, $current = null, $recvWindow = null)
    {
        $contentType = self::contentTypes['queryPortfolioMarginProBankruptcyLoanRepayHistory'][0];

        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling AccountApi.queryPortfolioMarginProBankruptcyLoanRepayHistory, must be smaller than or equal to 100.');
        }

        if (null !== $current && $current < 1) {
            throw new \InvalidArgumentException('invalid value for "$current" when calling AccountApi.queryPortfolioMarginProBankruptcyLoanRepayHistory, must be bigger than or equal to 1.');
        }
    ...
    public function queryPortfolioMarginProNegativeBalanceInterestHistoryRequest($asset = null, $startTime = null, $endTime = null, $size = null, $recvWindow = null)
    {
        ...
        if (null !== $size && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling AccountApi.queryPortfolioMarginProNegativeBalanceInterestHistory, must be smaller than or equal to 100.');
        }
