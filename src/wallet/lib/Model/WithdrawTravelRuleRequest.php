...
/**
 * WithdrawTravelRuleRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class WithdrawTravelRuleRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'withdrawTravelRuleRequest';
     ...
     *
     * @param null|string $withdrawOrderId withdrawID defined by the client (i.e. client's internal withdrawID)
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling WithdrawTravelRuleRequest., must be smaller than or equal to 60000.');
        }
