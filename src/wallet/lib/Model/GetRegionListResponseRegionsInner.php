...
class GetRegionListResponseRegionsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets regionName.
     *
     * @param null|string $regionName region/city display name (use this value in questionnaire answers)
     *
     * @return self
     */
     ...
     * Sets depositAllowed.
     *
     * @param null|bool $depositAllowed whether deposit is allowed for this region
     *
     * @return self
     */
     ...
     *
     * @param null|bool $withdrawalAllowed whether withdrawal is allowed for this region
     *
     * @return self
     */
