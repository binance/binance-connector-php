...
/**
 * FundingWalletRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class FundingWalletRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'fundingWalletRequest';
     ...
     *
     * @param null|bool $needBtcValuation needBtcValuation
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling FundingWalletRequest., must be smaller than or equal to 60000.');
        }
