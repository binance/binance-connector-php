...
/**
 * SubmitDepositQuestionnaireTravelRuleRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class SubmitDepositQuestionnaireTravelRuleRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'submitDepositQuestionnaireTravelRuleRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['tranId']) {
            $invalidProperties[] = "'tranId' can't be null";
        }
     ...
     * Sets tranId.
     *
     * @param int $tranId Wallet tran ID
     *
     * @return self
     */
