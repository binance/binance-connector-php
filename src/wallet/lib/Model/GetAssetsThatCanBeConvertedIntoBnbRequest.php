...
/**
 * GetAssetsThatCanBeConvertedIntoBnbRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class GetAssetsThatCanBeConvertedIntoBnbRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getAssetsThatCanBeConvertedIntoBnbRequest';
    ...
    protected static $openAPITypes = [
        'accountType' => '\Binance\Client\Wallet\Model\AccountType',
        'recvWindow' => 'int',
    ];
     ...
     * Sets accountType.
     *
     * @param null|AccountType $accountType accountType
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling GetAssetsThatCanBeConvertedIntoBnbRequest., must be smaller than or equal to 60000.');
        }
