...
class WithdrawRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param null|string $withdrawOrderId client side id for withdrawal, if provide here, can be used in GET `/sapi/v1/capital/withdraw/history` for query
     *
     * @return self
     */
     ...
     * Sets network.
     *
     * @param null|string $network Withdrawal network
     *
     * @return self
     */
     ...
     * Sets addressTag.
     *
     * @param null|string $addressTag secondary address identifier for coins like XRP,XMR etc
     *
     * @return self
     */
     ...
     *
     * @param null|bool $transactionFeeFlag When making internal transfer, `true` for returning the fee to the destination account; `false` for returning the fee back to the departure account. Default `false`.
     *
     * @return self
     */
     ...
     * Sets walletType.
     *
     * @param null|int $walletType The wallet type for withdraw，0-spot wallet ，1-funding wallet. Default walletType is the current \"selected wallet\" under wallet->Fiat and Spot/Funding->Deposit
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling WithdrawRequest., must be smaller than or equal to 60000.');
        }
