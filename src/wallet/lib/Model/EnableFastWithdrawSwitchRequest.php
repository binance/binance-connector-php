...
/**
 * EnableFastWithdrawSwitchRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class EnableFastWithdrawSwitchRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'enableFastWithdrawSwitchRequest';
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling EnableFastWithdrawSwitchRequest., must be smaller than or equal to 60000.');
        }
