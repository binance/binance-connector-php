...
class GetCountryListResponseCountriesInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets countryCode.
     *
     * @param null|string $countryCode ISO 2-digit country code, lowercase
     *
     * @return self
     */
     ...
     * Sets countryName.
     *
     * @param null|string $countryName country display name
     *
     * @return self
     */
     ...
     * Sets blockType.
     *
     * @param null|string $blockType `supported`, `limited`, or `blocked`
     *
     * @return self
     */
     ...
     * Sets depositAllowed.
     *
     * @param null|bool $depositAllowed whether deposit is allowed for this country
     *
     * @return self
     */
     ...
     *
     * @param null|bool $withdrawalAllowed whether withdrawal is allowed for this country
     *
     * @return self
     */
     ...
     *
     * @param null|bool $hasRegionRestrictions whether this country has region-level restrictions
     *
     * @return self
     */
