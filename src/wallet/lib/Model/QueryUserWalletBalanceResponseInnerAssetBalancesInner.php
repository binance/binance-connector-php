...
/**
 * QueryUserWalletBalanceResponseInnerAssetBalancesInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class QueryUserWalletBalanceResponseInnerAssetBalancesInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'queryUserWalletBalanceResponse_inner_assetBalances_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('btcValuation', $data ?? [], null);
    }
    ...
    {
        return $this->container['btcValuation'];
    }

    /**
     * Sets btcValuation.
     *
     * @param null|string $btcValuation btcValuation
     *
     * @return self
     */
    public function setBtcValuation($btcValuation)
    {
        if (is_null($btcValuation)) {
            throw new \InvalidArgumentException('non-nullable btcValuation cannot be null');
        }
        $this->container['btcValuation'] = $btcValuation;
