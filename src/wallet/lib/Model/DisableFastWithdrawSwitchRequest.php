...
/**
 * DisableFastWithdrawSwitchRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class DisableFastWithdrawSwitchRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'disableFastWithdrawSwitchRequest';
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling DisableFastWithdrawSwitchRequest., must be smaller than or equal to 60000.');
        }
