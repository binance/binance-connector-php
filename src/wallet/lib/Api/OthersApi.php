...
class OthersApi
{
    ...
    public function getSymbolsDelistScheduleForSpotRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling OthersApi.getSymbolsDelistScheduleForSpot, must be smaller than or equal to 60000.');
        }
