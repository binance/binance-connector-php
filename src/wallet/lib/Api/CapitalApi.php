...
class CapitalApi
{
    ...
    public function allCoinsInformationRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling CapitalApi.allCoinsInformation, must be smaller than or equal to 60000.');
        }
    ...
    public function depositAddressRequest($coin, $network = null, $amount = null, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling CapitalApi.depositAddress, must be smaller than or equal to 60000.');
        }
    ...
    public function depositHistoryRequest($includeSource = null, $coin = null, $status = null, $startTime = null, $endTime = null, $offset = null, $limit = null, $recvWindow = null, $txId = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling CapitalApi.depositHistory, must be smaller than or equal to 1000.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling CapitalApi.depositHistory, must be smaller than or equal to 60000.');
        }
     ...
     * One click arrival deposit apply (for expired address deposit) (USER_DATA)
     *
     * @param null|OneClickArrivalDepositApplyRequest $oneClickArrivalDepositApplyRequest (optional)
     *
     * @return ApiResponse<OneClickArrivalDepositApplyResponse>
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function oneClickArrivalDepositApplyWithHttpInfo($oneClickArrivalDepositApplyRequest = null): ApiResponse
    {
     ...
     * @throws \InvalidArgumentException
     */
    public function oneClickArrivalDepositApplyRequest($oneClickArrivalDepositApplyRequest = null)
    {
    ...
    public function withdrawHistoryRequest($coin = null, $withdrawOrderId = null, $status = null, $offset = null, $limit = null, $idList = null, $startTime = null, $endTime = null, $recvWindow = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling CapitalApi.withdrawHistory, must be smaller than or equal to 1000.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling CapitalApi.withdrawHistory, must be smaller than or equal to 60000.');
        }
