...
class TravelRuleApi
{
    ...
    public function checkQuestionnaireRequirementsRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TravelRuleApi.checkQuestionnaireRequirements, must be smaller than or equal to 60000.');
        }
    ...
    public function depositHistoryTravelRuleRequest($trId = null, $txId = null, $tranId = null, $network = null, $coin = null, $travelRuleStatus = null, $pendingQuestionnaire = null, $startTime = null, $endTime = null, $offset = null, $limit = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling TravelRuleApi.depositHistoryTravelRule, must be smaller than or equal to 1000.');
        }
    ...
    public function depositHistoryV2Request($depositId = null, $txId = null, $network = null, $coin = null, $retrieveQuestionnaire = null, $startTime = null, $endTime = null, $offset = null, $limit = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling TravelRuleApi.depositHistoryV2, must be smaller than or equal to 1000.');
        }
    ...
    public function fetchAddressVerificationListRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TravelRuleApi.fetchAddressVerificationList, must be smaller than or equal to 60000.');
        }
    ...
    {
        return $this->getCountryListWithHttpInfo($recvWindow);
    }
     ...
     * @throws \InvalidArgumentException
     */
    public function getCountryListWithHttpInfo($recvWindow = null): ApiResponse
    {
        $request = $this->getCountryListRequest($recvWindow);
     ...
     * @throws \InvalidArgumentException
     */
    public function getCountryListRequest($recvWindow = null)
    {
        $contentType = self::contentTypes['getCountryList'][0];

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TravelRuleApi.getCountryList, must be smaller than or equal to 60000.');
        }
    ...
    {
        return $this->getRegionListWithHttpInfo($countryCode, $recvWindow);
    }
     ...
     * @throws \InvalidArgumentException
     */
    public function getRegionListWithHttpInfo($countryCode, $recvWindow = null): ApiResponse
    {
        $request = $this->getRegionListRequest($countryCode, $recvWindow);
     ...
     * @throws \InvalidArgumentException
     */
    public function getRegionListRequest($countryCode, $recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TravelRuleApi.getRegionList, must be smaller than or equal to 60000.');
        }
    ...
    public function vaspListRequest($recvWindow = null)
    {
        ...
        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TravelRuleApi.vaspList, must be smaller than or equal to 60000.');
        }
    ...
    public function withdrawHistoryV1Request($trId = null, $txId = null, $withdrawOrderId = null, $network = null, $coin = null, $travelRuleStatus = null, $offset = null, $limit = null, $startTime = null, $endTime = null, $recvWindow = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling TravelRuleApi.withdrawHistoryV1, must be smaller than or equal to 1000.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TravelRuleApi.withdrawHistoryV1, must be smaller than or equal to 60000.');
        }
    ...
    public function withdrawHistoryV2Request($trId = null, $txId = null, $withdrawOrderId = null, $network = null, $coin = null, $travelRuleStatus = null, $offset = null, $limit = null, $startTime = null, $endTime = null, $recvWindow = null)
    {
        ...
        if (null !== $limit && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling TravelRuleApi.withdrawHistoryV2, must be smaller than or equal to 1000.');
        }

        if (null !== $recvWindow && $recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for "$recvWindow" when calling TravelRuleApi.withdrawHistoryV2, must be smaller than or equal to 60000.');
        }
