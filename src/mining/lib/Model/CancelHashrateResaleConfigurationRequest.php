...
/**
 * CancelHashrateResaleConfigurationRequest Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class CancelHashrateResaleConfigurationRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'cancelHashrateResaleConfigurationRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['configId']) {
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling CancelHashrateResaleConfigurationRequest., must be smaller than or equal to 60000.');
        }
