...
class HashrateResaleRequestRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets endDate.
     *
     * @param int $endDate Resale End Time (Millisecond timestamp)
     *
     * @return self
     */
     ...
     * Sets startDate.
     *
     * @param int $startDate Resale Start Time(Millisecond timestamp)
     *
     * @return self
     */
     ...
     * Sets hashRate.
     *
     * @param int $hashRate Resale hashrate h/s must be transferred (BTC is greater than 500000000000 ETH is greater than 500000)
     *
     * @return self
     */
    ...
    public function setRecvWindow($recvWindow)
    {
        ...
        if ($recvWindow > 60000) {
            throw new \InvalidArgumentException('invalid value for $recvWindow when calling HashrateResaleRequestRequest., must be smaller than or equal to 60000.');
        }
