...
class StatisticListResponseData implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'validNum' => 'int',
        'invalidNum' => 'int',
        'profitToday' => 'array<string,string>',
        'profitYesterday' => 'array<string,string>',
        'userName' => 'string',
        'unit' => 'string',
        'algo' => 'string',
    ];
     ...
     *
     * @param null|string $fifteenMinHashRate 15-minute hashrate
     *
     * @return self
     */
     ...
     * Sets dayHashRate.
     *
     * @param null|string $dayHashRate 24H hashrate
     *
     * @return self
     */
     ...
     * Sets validNum.
     *
     * @param null|int $validNum Effective quantity
     *
     * @return self
     */
     ...
     * Sets invalidNum.
     *
     * @param null|int $invalidNum Invalid quantity
     *
     * @return self
     */
     ...
     * Sets profitToday.
     *
     * @param null|array<string,string> $profitToday Today's estimate. Keys are coin symbols (e.g. BTC, BSV, BCH), values are earning amounts as strings.
     *
     * @return self
     */
     ...
     *
     * @param null|array<string,string> $profitYesterday Yesterday's earnings. Keys are coin symbols (e.g. BTC, BSV, BCH), values are earning amounts as strings.
     *
     * @return self
     */
     ...
     * Sets userName.
     *
     * @param null|string $userName Mining account
     *
     * @return self
     */
     ...
     * Sets algo.
     *
     * @param null|string $algo Algorithm
     *
     * @return self
     */
