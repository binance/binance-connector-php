...
/**
 * RequestForDetailMinerListResponseDataInnerHashrateDatasInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class RequestForDetailMinerListResponseDataInnerHashrateDatasInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'requestForDetailMinerListResponse_data_inner_hashrateDatas_inner';
     ...
     * Sets hashrate.
     *
     * @param null|string $hashrate Hashrate
     *
     * @return self
     */
     ...
     * Sets reject.
     *
     * @param null|int $reject Rejection rate
     *
     * @return self
     */
