...
/**
 * CreateADualTokenGiftCardResponseData Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class CreateADualTokenGiftCardResponseData implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createADualTokenGiftCardResponse_data';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('expiredTime', $data ?? [], null);
    }
     ...
     * Sets expiredTime.
     *
     * @param null|int $expiredTime expiredTime
     *
     * @return self
     */
    public function setExpiredTime($expiredTime)
    {
        if (is_null($expiredTime)) {
            throw new \InvalidArgumentException('non-nullable expiredTime cannot be null');
        }
