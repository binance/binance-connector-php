...
class RebateApiTest extends TestCase
{
    ...
    /**
     * Test case for getSpotRebateHistoryRecords.
     *
     * Get Spot Rebate History Records (USER_DATA).
     */
    public function testGetSpotRebateHistoryRecords()
    {
        $startTime = 1623319461670;
        $endTime = 1641782889000;
        $page = 1;
        $recvWindow = 5000;
        $response = $this->getApiMock($request)->getSpotRebateHistoryRecords($startTime, $endTime, $page, $recvWindow);

        parse_str($request->getUri(), $queryMap);

        self::assertEquals(200, $response->getStatusCode());
        self::assertEquals('/sapi/v1/rebate/taxQuery', $request->getUri()->getPath());
