...
class UserDataStreamsApi
{
    ...
    public function closeUserDataStreamRequest()
    {
        ...
        $resourcePath = '/fapi/v1/listenKey';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
            ...
            switch ($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Binance\Client\DerivativesTradingUsdsFutures\Model\KeepaliveUserDataStreamResponse',
                        $request,
                        $response,
                    );
            }
    ...
    public function startUserDataStreamWithHttpInfo(): ApiResponse
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Binance\Client\DerivativesTradingUsdsFutures\Model\StartUserDataStreamResponse',
                        $request,
                        $response,
                    );
            }
