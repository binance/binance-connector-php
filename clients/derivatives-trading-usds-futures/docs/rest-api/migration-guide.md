# Migration Guide: Binance USDS Connector Modularization
...
1. **Package Name**:  
   The modularised USDS Connector has been moved to a new package:
...
```bash
composer require binance/derivatives-trading-usds-futures
```
