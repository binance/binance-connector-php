...
/**
 * QueryLimitOpenOrdersResponseListInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class QueryLimitOpenOrdersResponseListInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'queryLimitOpenOrdersResponse_list_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('expiredTimestamp', $data ?? [], null);
    }
    ...
    {
        return $this->container['expiredTimestamp'];
    }

    /**
     * Sets expiredTimestamp.
     *
     * @param null|int $expiredTimestamp expiredTimestamp
     *
     * @return self
     */
    public function setExpiredTimestamp($expiredTimestamp)
    {
        if (is_null($expiredTimestamp)) {
            throw new \InvalidArgumentException('non-nullable expiredTimestamp cannot be null');
        }
