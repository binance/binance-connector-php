...
/**
 * SorOrderResponseFillsInner Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class SorOrderResponseFillsInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'sorOrderResponse_fills_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('allocId', $data ?? [], null);
    }
     ...
     * Sets matchType.
     *
     * @param null|string $matchType matchType
     *
     * @return self
     */
     ...
     * @return null|int
     */
    public function getAllocId()
    {
        return $this->container['allocId'];
    }

    /**
     * Sets allocId.
     *
     * @param null|int $allocId allocId
     *
     * @return self
     */
    public function setAllocId($allocId)
    {
        if (is_null($allocId)) {
            throw new \InvalidArgumentException('non-nullable allocId cannot be null');
        }
        $this->container['allocId'] = $allocId;
