# Migration Guide: Binance Staking Connector Modularization
...
4. **Configuration and Client Initialization**:  
   The new structure keeps the existing configuration options but modularized clients into `StakingRestApi`.
...
```bash
composer require binance/staking
```
