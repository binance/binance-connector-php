...
/**
 * GetSolStakingQuotaDetailsResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class GetSolStakingQuotaDetailsResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getSolStakingQuotaDetailsResponse';
    ...
    protected static $setters = [
        ...
        'nextEpochTime' => 'setNextEpochTime',
    ...
    protected static $getters = [
        ...
        'nextEpochTime' => 'getNextEpochTime',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('soldOut', $data ?? [], null);
        $this->setIfExists('commissionFee', $data ?? [], null);
        $this->setIfExists('nextEpochTime', $data ?? [], null);
     ...
     * Sets soldOut.
     *
     * @param null|bool $soldOut soldOut
     *
     * @return self
     */
    ...
    {
        if (is_null($soldOut)) {
            throw new \InvalidArgumentException('non-nullable soldOut cannot be null');
        }
     ...
     * @return null|int
     */
    public function getNextEpochTime()
    {
        return $this->container['nextEpochTime'];
    }

    /**
     * Sets nextEpochTime.
     *
     * @param null|int $nextEpochTime nextEpochTime
     *
     * @return self
     */
    public function setNextEpochTime($nextEpochTime)
    {
        if (is_null($nextEpochTime)) {
            throw new \InvalidArgumentException('non-nullable nextEpochTime cannot be null');
        }
        $this->container['nextEpochTime'] = $nextEpochTime;
