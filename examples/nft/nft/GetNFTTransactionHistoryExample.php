...
function getNFTTransactionHistoryExample()
{
    ...
    $page = 1;
    $recvWindow = 5000;
    $response = $api->getNFTTransactionHistory($orderType, $startTime, $endTime, $limit, $page, $recvWindow);
    print_r($response);
}

getNFTTransactionHistoryExample();
