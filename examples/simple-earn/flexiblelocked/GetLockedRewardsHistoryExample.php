...
function getLockedRewardsHistoryExample()
{
    ...
    $size = 10;
    $recvWindow = 5000;
    $response = $api->getLockedRewardsHistory($positionId, $asset, $startTime, $endTime, $current, $size, $recvWindow);
    print_r($response);
}

getLockedRewardsHistoryExample();
