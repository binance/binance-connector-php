...
function getSimpleEarnLockedProductListExample()
{
    ...
    $size = 10;
    $recvWindow = 5000;
    $response = $api->getSimpleEarnLockedProductList($asset, $current, $size, $recvWindow);
    print_r($response);
}

getSimpleEarnLockedProductListExample();
