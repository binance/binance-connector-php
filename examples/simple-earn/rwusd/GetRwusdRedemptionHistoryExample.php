...
function getRwusdRedemptionHistoryExample()
{
    ...
    $size = 10;
    $recvWindow = 5000;
    $response = $api->getRwusdRedemptionHistory($startTime, $endTime, $current, $size, $recvWindow);
    print_r($response);
}

getRwusdRedemptionHistoryExample();
