...
function getRwusdSubscriptionHistoryExample()
{
    ...
    $size = 10;
    $recvWindow = 5000;
    $response = $api->getRwusdSubscriptionHistory($asset, $startTime, $endTime, $current, $size, $recvWindow);
    print_r($response);
}

getRwusdSubscriptionHistoryExample();
