...
function getVIPLoanRepaymentHistoryExample()
{
    ...
    $limit = 10;
    $recvWindow = 5000;
    $response = $api->getVIPLoanRepaymentHistory($orderId, $loanCoin, $startTime, $endTime, $current, $limit, $recvWindow);
    print_r($response);
}

getVIPLoanRepaymentHistoryExample();
