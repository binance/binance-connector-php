...
function previewOtcBlocktradeExample()
{
    ...
    $previewOtcBlocktradeRequest = new PreviewOtcBlocktradeRequest();
    $previewOtcBlocktradeRequest->setSecretToken('a1b2c3d4-e5f6-7890-abcd-ef1234567890');
    $response = $api->previewOtcBlocktrade($previewOtcBlocktradeRequest);
    print_r($response);
}

previewOtcBlocktradeExample();
