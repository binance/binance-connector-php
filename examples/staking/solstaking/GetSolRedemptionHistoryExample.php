...
function getSolRedemptionHistoryExample()
{
    ...
    $size = 10;
    $recvWindow = 5000;
    $response = $api->getSolRedemptionHistory($redeemId, $startTime, $endTime, $current, $size, $recvWindow);
    print_r($response);
}

getSolRedemptionHistoryExample();
