...
function getFlexibleLoanBorrowHistoryExample()
{
    ...
    $limit = 10;
    $recvWindow = 5000;
    $response = $api->getFlexibleLoanBorrowHistory($loanCoin, $collateralCoin, $startTime, $endTime, $current, $limit, $recvWindow);
    print_r($response);
}

getFlexibleLoanBorrowHistoryExample();
