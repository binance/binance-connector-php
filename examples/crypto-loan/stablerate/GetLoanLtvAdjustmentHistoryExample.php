...
function getLoanLtvAdjustmentHistoryExample()
{
    ...
    $limit = 10;
    $recvWindow = 5000;
    $response = $api->getLoanLtvAdjustmentHistory($orderId, $loanCoin, $collateralCoin, $startTime, $endTime, $current, $limit, $recvWindow);
    print_r($response);
}

getLoanLtvAdjustmentHistoryExample();
