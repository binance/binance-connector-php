...
function getLoanRepaymentHistoryExample()
{
    ...
    $limit = 10;
    $recvWindow = 5000;
    $response = $api->getLoanRepaymentHistory($orderId, $loanCoin, $collateralCoin, $startTime, $endTime, $current, $limit, $recvWindow);
    print_r($response);
}

getLoanRepaymentHistoryExample();
