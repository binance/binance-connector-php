...
function mintBfusdForPortfolioMarginExample()
{
    ...
    $response = $api->mintBfusdForPortfolioMargin($mintBfusdForPortfolioMarginRequest);
    print_r($response);
}

mintBfusdForPortfolioMarginExample();
