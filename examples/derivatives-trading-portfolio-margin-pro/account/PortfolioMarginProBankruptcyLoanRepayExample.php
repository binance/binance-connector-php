...
function portfolioMarginProBankruptcyLoanRepayExample()
{
    ...
    $response = $api->portfolioMarginProBankruptcyLoanRepay($portfolioMarginProBankruptcyLoanRepayRequest);
    print_r($response);
}

portfolioMarginProBankruptcyLoanRepayExample();
