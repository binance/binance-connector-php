...
function transferLdusdtForPortfolioMarginExample()
{
    ...
    $response = $api->transferLdusdtForPortfolioMargin($transferLdusdtForPortfolioMarginRequest);
    print_r($response);
}

transferLdusdtForPortfolioMarginExample();
