...
function getOptionTransactionHistoryDownloadLinkByIdExample()
{
    ...
    $downloadId = '1';
    $recvWindow = 5000;
    $response = $api->getOptionTransactionHistoryDownloadLinkById($downloadId, $recvWindow);
    print_r($response);
}

getOptionTransactionHistoryDownloadLinkByIdExample();
