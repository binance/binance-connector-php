...
function getDownloadIdForOptionTransactionHistoryExample()
{
    ...
    $recvWindow = 5000;
    $response = $api->getDownloadIdForOptionTransactionHistory($startTime, $endTime, $recvWindow);
    print_r($response);
}

getDownloadIdForOptionTransactionHistoryExample();
