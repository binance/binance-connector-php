...
function startIsolatedMarginUserDataStreamExample()
{
    ...
    $response = $api->startIsolatedMarginUserDataStream($startIsolatedMarginUserDataStreamRequest);
    print_r($response);
}

startIsolatedMarginUserDataStreamExample();
